...
<head>
	...
	<?php $this->load->view('template/layout_home/css') ?>
...
<body>
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="input-icon">
									...
									<input type="text" class="form-control" name="usernamenya" placeholder="Masukkan Username" id="usernamenya" />
								</div>
							</div>
							<div class="form-group">
	...
	<?php $this->load->view('template/layout_home/js') ?>
