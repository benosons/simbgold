...
$pdf->AddPage();
$pdf->Image(BASE_FILE_PATH.'logo_dinas/'.$logo,95,15,22);
$pdf->Cell(200,25,'',0,1);
...
if ($result_list['id_fungsi_bg'] != 1) {
	...
	$pdf->MultiCell(0,5,'Berita Acara Hasil Pemeriksaan Dokumen Rencana Teknis Tim Teknis Dinas PUPR/Dinas Teknis yang membidangi Bangunan Gedung Nomor BA-321706-21102019-01  10-10-2019 (untuk Bangunan Gedung Bukan Kepentingan Umum)',0,'J',0);
}
...
if(trim($result_list['nama_dinas']) != ''){
  $nm_dinas = ucwords(strtoupper($result_list['nama_dinas']));
}else{
  $nm_dinas = 'DPMPTSP';
}
