...
<form action="<?php echo site_url('Pupr/saveDataKeahlian'); ?>" class="form-horizontal" role="form" method="post" id="Form_Data_Keahlian" enctype="multipart/form-data">
<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">		
	...
	<div class="col-md-12 ">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input class="form-control input-medium date-picker" size="16" type="text" name="tgl_penetapan" placeholder="Tanggal Penerbitan Sertifikat" value="<?php echo set_value('tgl_penetapan', (isset($DataPersonil->tgl_penetapan) ? date('d/m/Y', strtotime($DataPersonil->tgl_penetapan)) : '')) ?>" />
			</div>
		</div>
		<div class="form-group">
	...
	$("#Form_Data_Keahlian").validate({
	   ...
	   rules: {
	    ...
	    messages: {
			...
			nama_bidang: "Masukan Kualifikasi/Jabatan Fungsional",
