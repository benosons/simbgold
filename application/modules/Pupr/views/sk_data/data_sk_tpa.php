...
<div class="portlet light margin-top-20">
	<div class="portlet-title tabbable-line">
		<div class="caption caption-md">
			...
			<span class="caption-subject text-primary bold uppercase"><i class=""></i>Data Surat Keputusan</span>
		</div>
		<div class="actions"><a href="#" data-toggle="modal" data-target="#modal_psk" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah SK </a></div>
	</div>
							...
							<tr>
								...
								<td>
									<?php if($r->tipe_sk !='TPA'){ ?>
										<a href="<?php echo site_url('Pupr/personil_sk/' . $r->id_sk); ?>" class="btn btn-success btn-sm" title="Ubah Data Personil" data-toggle="modal" data-target="#personil-skPenilik"><span class="glyphicon glyphicon-user"></span></a>
									<?php }else{ ?>
										<a href="<?php echo site_url('Pupr/personil_tpap/' . $r->id_sk); ?>"
								...
								<td>
									<a href="javascript:void(0);" class="btn purple btn-sm" title="Lihat Berkas" onClick="javascript:get_PSK('<?php echo $r->file_sk ?>')"> <i class="fa fa-file"></i></a>
									<a class="btn btn-warning btn-sm" onClick="UbahPSK('<?php echo $r->id_sk; ?>')" title="Ubah SK"><span class="glyphicon glyphicon-pencil"></span></a>
									<a class="btn btn-danger btn-sm" data-href="<?php echo site_url('Pupr/hapus_psk/' . $r->id_sk); ?>"data-confirm="Anda yakin ingin menghapus data ini ?" title="Hapus Data SK"><span class="glyphicon glyphicon-trash"></span></a>
								</td>
							</tr>
						<?php }
                    } ?>
...
<div id="modal_psk" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog" data-backdrop="static" data-width="40%" data-keyboard="false">
	<?php echo form_open_multipart('Pupr/simpan_sk', [
...
<div id="personil-skPenilik" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog" data-backdrop="static"
	data-keyboard="false" data-width="560px">
	<div class="modal-content">
		<div class="modal-body">
			<?php $this->load->view('personil_tpa'); ?>
		</div>
	</div>
</div>
...
<script>
	...
	function UbahPSK(id) {
		$.ajax({
			type: "GET",
			url: "<?php echo base_url('Pupr/ubah_psk/') ?>",
			dataType: "JSON",
			data: {
				id: id
			},
