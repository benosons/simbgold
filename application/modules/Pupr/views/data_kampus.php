					...
					<div class="portlet light ">
						<div class="portlet-title">
							<div class="caption caption-md">
								...
								<span class="caption-subject text-primary bold uppercase">List Data Perguruan Tinggi</span>
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
											<table class="table table-bordered btable" style="min-height:350px;">
												...
												<tbody>
													<?php if ($dat_kampus->num_rows() > 0) {
														$no = 1;
														foreach ($dat_kampus->result() as $r) { ?>
													<tr>
														<td align="center"><?php echo $no++; ?></td>
														<td><?php echo $r->nm_asosiasi; ?></td>
														<td><?php echo $r->alamat; ?></td>
														<td><?php echo $r->no_tlp; ?></td>
														<td align="center"><a onClick="UbahKampus('<?php echo $r->id; ?>')"
														...
														<td align="center">
															<a data-href="<?php echo site_url('Pupr/hapus_kampus/' . $r->id); ?>"
...
<div id="responKAM" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog" data-backdrop="static" data-width="600px" data-keyboard="false">
	<?php echo form_open_multipart('Pupr/simpan_kampus', [
	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<span class="caption-subject text-primary bold uppercase " style="font-size:15px;">Form Data Perguruan Tinggi</span>
		</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<div class="input-group">
													...
													<input class="form-control" name="nama_as" type="text" placeholder="Nama Perguruan Tinggi" autocomplete="off">
													<input style="display:none;" class="form-control" name="id_as" placeholder="id_as" autocomplete="off">
													<label for="form_control_1">Nama Perguruan Tinggi <span class="required" aria-required="true"> * </span></label>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<div class="input-group">
													...
													<textarea class="form-control" rows="3" name="alamat_as" placeholder="Alamat Perguruan Tinggi"></textarea>
													<label for="form_control_1">Alamat Perguruan Tinggi <span class="required" aria-required="true"> * </span></label>
												</div>
											</div>
										</div>
										<div class="col-md-12">
...
<script>
	...
	function Rese2() {
		document.getElementById("tambah_kamp").reset();
	};
	
	function UbahKampus(id) {
		$.ajax({
			type: "GET",
			url: "<?php echo base_url('Pupr/ubah_kampus/') ?>",
			dataType: "JSON",
			data: {
				id: id
			},
