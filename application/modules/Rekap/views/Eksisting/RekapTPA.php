				...
				<tbody>
					...
					<?php if ($jum_data == 0) { ?>
						...
						<tr class="<?= $clss ?>" id="record">
							...
							<td class="center"><b><center><?php echo $t_AkaCalon; ?></center></b></td>
							<td class="center"><b><center><?php echo $t_AkaTpa; ?></b></td>
							<td class="center"><b><center><?php echo $t_AsoCalon; ?></b></td>
							<td class="center"><b><center><?php echo $t_AsoTpa; ?></b></td>
							<td class="center"><b><center><?php echo $t_PakarCalon; ?></b></td>
							<td class="center"><b><center><?php echo $t_PakarTpa; ?></b></td>
							<td class="center"><b><center><?php echo $t_total; ?></b></center></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
