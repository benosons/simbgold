...
function resetCari() {	
	var url = "<?php echo base_url() . index_page() ?>rekap/RekapSlf/";
	$('#loading').fadeIn();
...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-globe"></i>Rekap Permohonan SLF dengan SIMBG
		</div>
		<div class="tools">
	...
	<div class="portlet-body">
		<div class="form-actions">
			<?php echo form_open('rekap/RekapSlf',array('name'=>'frmListRekapInformasi', 'id'=>'frmListRekapInformasi')); ?>
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group col-md-12">
							<label class="control-label col-md-3"><b>Status Permohonan SLF</b></label>
							<div class="col-md-9">
								<div class="col-md-5">
						...
						<!--<div class="form-group col-md-12">
							<label class="control-label col-md-3"><b>Periode Tanggal Permohonan SLF</b></label>
							<div class="col-md-9">
								<div class="col-md-2">
						...
						<!--<div class="form-group col-md-12">
							<label class="control-label col-md-3"><b>Periode Tanggal Penerbitan SLF</b></label>
							<div class="col-md-9">
								<div class="col-md-2">
									<input type="text" class="form-control date-picker" data-date-format="dd/mm/yyyy" name="tanggalawal" value="" placeholder="01/01/1990"/>
								</div>
					...
					<?php
						...
						<?}else{
							...
							<tr class="<?=$clss?>" id="record">
								...
								<td class="clcenter"><?if ($Non_NIB == 0){?>0<?}else{?><u><a href="<?=base_url().index_page()?>rekap/rekap_detail/<?php echo $row->id_kabkot; ?>/1/<? echo $status2;?>">
								<?php echo $Non_NIB;?><?}?></td>
									<td class="clcenter"><?if ($NIB == 0){?>0<?}else{?><u><a href="<?=base_url().index_page()?>rekap/rekap_detail/<?php echo $row->id_kabkot; ?>/2/<? echo $status2;?>">
								<?php echo $NIB;?><?}?></td>
