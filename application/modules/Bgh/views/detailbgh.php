                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="card shadow">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <a target="_blank" href="<?= base_url('assets/files/'.$permohonan->id.'/dokbgh/' . $f->file) ?>"><i class="fa fa-download"></i> Lihat File</a>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <?php
                                                                            if ($f->verifikasi == 1 && $f->new == 0) {
                                        ...
                                        ?>
                                                        ...
                                                        <div class="card shadow">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <a target="_blank" href="<?= base_url('assets/files/'.$permohonan->id.'/dokarsitektur/' . $fa->file) ?>"><i class="fa fa-download"></i> Lihat File</a>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <?php
                                                                            if ($fa->verifikasi == 1 && $fa->new == 0) {
                                                       ...
                                                       <div class="col-md-4">
                                                        <div class="card shadow">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <a target="_blank" href="<?= base_url('assets/files/'.$permohonan->id.'/dokstruktur/' . $fs->file) ?>"><i class="fa fa-download"></i> Lihat File</a>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <?php
                                                                            if ($fs->verifikasi == 1 && $fs->new == 0) {
                                        ...
                                        ?>
                                                        ...
                                                        <div class="card shadow">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <a target="_blank" href="<?= base_url('assets/files/'.$permohonan->id.'/dokmep/' . $fm->file) ?>"><i class="fa fa-download"></i> Lihat File</a>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <?php
                                                                            if ($fm->verifikasi == 1 && $fm->new == 0) {
