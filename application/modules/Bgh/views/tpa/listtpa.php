    ...
    $(() => {
        ...
        $('#table').DataTable({
            ...
            aoColumns: [
                ...
                { data: 'id' },
                { data: 'nip' },
                { data: 'tmpt_lahir' }, // Custom column
                { data: 'id' } // Custom column
            ],
            aoColumnDefs: [
                {
                    mRender: function (data, type, row) {
                        var el = `${row.glr_depan} ${row.nm_tpa} ${row.glr_belakang}`;
                ...
                },
                {
                    mRender: function (data, type, row) {
                        ...
                        el += `<a class="detailtpa" href="javascript:;" data-id="${row.id}">Detail</a>`;
