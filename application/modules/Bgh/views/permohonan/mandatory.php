                        ...
                        <div class="col-md-12 text-center p-0 mt-3 mb-2">
                            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                ...
                                <div class="card-header text-start">
                                    <a href="<?= base_url()?>Bgh/permohonanbgh"><i class="fa fa-arrow-left"></i> Kembali</a>
                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card shadow text-start">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="luas_bangunan" class="form-control-label">Luas Bangunan</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="klas_bangunan" class="form-control-label">
                                                            ...
                                                            <div class="card shadow text-start">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <div class="form-group">
                                                                                <label for="glr_depan" class="form-control-label">Gelar Depan</label>
                                                                        ...
                                                                        <div class="col-4">
                                                                            <div class="form-group">
                                                                                <label for="nm_pemilik" class="form-control-label">Nama</label>
                                                                        ...
                                                                        <div class="col-4">
                                                                            <div class="form-group">
                                                                                <label for="glr_belakang" class="form-control-label">Gelar Belakang</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="no_kitas" class="form-control-label">No Kitas</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="id_provinsi" class="form-control-label">Provinsi</label>
                                                                        <select name="id_provinsi" id="id_provinsi" class="choices form-select" required>
                                                                            <option value="">PILIH</option>
                                                                            <?php 
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="id_kabkot" class="form-control-label">Kota/Kabupaten</label>
                                                                        <select name="id_kabkot" id="id_kabkot" class="choices form-select" required>
                                                                            <option value="">PILIH</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="id_kecamatan" class="form-control-label">Kecamatan</label>
                                                                        <select name="id_kecamatan" id="id_kecamatan" class="choices form-select" required>
                                                                            <option value="">PILIH</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="id_kelurahan" class="form-control-label">Kelurahan</label>
                                                                        <select name="id_kelurahan" id="id_kelurahan" class="choices form-select" required>
                                                                            <option value="">PILIH</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="email" class="form-control" name="email" id="email" value="<?= (!empty($pengajuan)) ? $pengajuan->email:'' ?>" autocomplete="off" placeholder="Masukan Email" >
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="unit_organisasi" class="form-control-label">Unit Organisasi</label>
...
<script src="<?= base_url() ?>assets/bgh/vendors/choices.js/choices.js"></script>
<script>
