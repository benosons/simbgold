    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Pengajuan Sertifikasi Bangunan Gedung Hijau H2M</h3>
            </div>
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">H2M</a>
                            </li>
                            <!-- <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="card mt-3">
                                    <div class="card-header">
                                        <?= ($this->session->userdata('loc_role_id') == 10) ? '<a href="'.base_url().'bgh/pengajuan/formh2m" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Ajukan Sertifikasi BGH H2M</a>' : '' ?>
                                    </div>
                                    <div class="card-body">
