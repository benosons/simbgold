                                    ...
                                    <div class="col-md-12 mx-0">
                                        <form id="msform" enctype="multipart/form-data">
                                            ...
                                            <ul id="progressbar" class="d-flex justify-content-center">
                                                <li class="active" id="account"><strong>Pengecekkan Kode BGH</strong></li>
                                                <li id="personal"><strong>Upload Dokumen BGH H2M</strong></li>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 text-start">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label for="kodebgh" class="form-control-label">Kode BGH</label>
                                                                    <input type="text" class="form-control" id="kodebgh" name="kodebgh" value="BGH-1234-5678">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
