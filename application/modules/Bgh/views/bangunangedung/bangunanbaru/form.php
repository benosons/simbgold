                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="" class="form-select <?= $elparent ?>" id="<?= $elparent ?>" onchange="claimpoin('<?= $elparent?>', '0',<?= $pilihansub ?>, event, <?= $poinsub?> )" <?= ($ambilsub == 1) ? 'disabled="disabled"':'' ?> >
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select name="" class="form-control <?= $elparent ?>" id="<?= $elchild ?>" onchange="claimpoin('<?= $elparent?>', '<?= $elchild ?>',<?= $pilihansub ?>, event, <?= $poinsubsub?> )" <?= ($ambilsubsub == 1) ? 'disabled="disabled"':'' ?> >
                                                                        <option value="0">TIDAK</option>
