                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <ul class="steps steps-green steps-counter my-4">
                            ...
                            <li class="step-item active">Proses Verifikasi Permohonan / Penerbitan Sertifikat BGH</li>
                        </ul>
                    </div>
                </div>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            if ($dok[$o]['isupload'] == 1) {
                                                                ...
                                                                <td>
                                                                <?php if($catatansub == "" || $catatansubsub == 0){ echo "";?>
                                                                    <?php }else{ ?>
                                                                        <div class="fw-bold">
                                                                        <?= $catatansub ?>
                                                                        </div>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                <?php if($catatansubsub == "" || $catatansubsub == 0){ echo "";?>
                                                                    <?php }else{ ?>
                                                                        <div class="fw-bold">
                                                                        <?= $catatansubsub ?>
                                                                        </div>
