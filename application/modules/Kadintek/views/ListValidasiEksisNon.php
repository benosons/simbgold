...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-globe"></i>List Validasi Kepala Dinas Teknis Bangunan Eksisting Belum Memiliki Izin Mendirikan Bangunan</div>
                ...
                <?php if ($Kadis->num_rows() > 0) {
                    ...
                    foreach ($Kadis->result() as $Kadis) { ?>
                        ...
                        <tr class="<?= $clss ?>">
                            ...
                            <?php } else { ?>
                                <td align="center">
                                    <!--<a href="#" onclick="GetCetakRekomtek(<?php echo $this->secure->encrypt_url($Kadis->id) ?>)" class="btn btn-info btn" title="Cetak Rekomtek" id="tombolinver"><span class="glyphicon glyphicon-print"> Terverifikasi (Lihat Rekomtek)</span></a>-->
...
<div id="dialog-popup" class="modal fade bs-modal-sm" data-width="55%" tabindex="-1" aria-hidden="true" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-content">
        <form action="<?php echo site_url('Pemeriksaan/FormVerifikasi'); ?>" class="form-horizontal" role="form" method="post">
