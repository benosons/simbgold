<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>List Validasi Penerbitan SLF dan SBKBG BGFK</div>
		<div class="tools"><a href="javascript:;" class="reload"></a></div>
	</div>
	<div class="portlet-body">
		<div class="form-actions">
			<?php echo form_open('Teknis/ValidasiSBKBG',array('name'=>'frmListVerifikasi', 'id'=>'frmListVerifikasi')); ?>
			<div class="row">
				<div class="col-md-12">
...
<div class="modal fade" id="dialog-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  	<div class="modal-dialog modal-lg">
 		<form action="<?php echo site_url('Teknis/ValidasiSLF'); ?>" class="form-horizontal" role="form" method="post">
    		<div class="modal-content">
      			...
      			<div class="modal-footer">
					...
					<center><button type="submit" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-check"></span>Validasi Menteri PUPR</button></center>
     			</div>
   			</div>
		</form>
 	 </div>
...
function GetCetakDokumen(id)
	{
		var url = "<?php echo base_url() . index_page() ?>Teknis/ValidasiSLF/";
		swin = window.open(url,'win','scrollbars,width=1000,height=600,top=80,left=140,status=yes,toolbar=no,menubar=yes,location=no');
		swin.focus();
	}
function GetCetakDraf(id)
{
	$("#MyModalBody").html('<iframe src="<?php echo base_url();?>Teknis/ValidasiSLF/'+id+'" frameborder="no" width="860" height="540"></iframe>');
	$('[name="id"]').val(id) ; 
}
</script>