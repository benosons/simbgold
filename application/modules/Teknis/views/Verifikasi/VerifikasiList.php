<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>List Data Verifikasi Konsultasi</div>
						  ...
						  <td align="center">
							...
							<?php } else { ?>
								<?php  if ($Konsultasi->status == 2) { ?>
									<td align="center"><a href="#" onClick="href='<?php echo site_url('DataDetail/DataKonsultasi/'.$Konsultasi->id);?>'" class="btn btn-info btn-sm" title="Lihat Data" id="tombolinver" data-toggle="modal" data-target="#modal-edit"><span class="glyphicon glyphicon-user"></span></a></td>
								<?php } else { ?>
									<td align="center"><a href="#" onClick="href='<?php echo site_url('Teknis/FormVerifikasi/'.$Konsultasi->id);?>'" class="btn btn-success btn-sm" title="Verifikasi Data" id="tombolver" data-toggle="modal" data-target="#modal-edit"><span class="glyphicon glyphicon-edit"></span></a></td>
								<?php } ?>
							<?php } ?>
						</tr>
	                <?php }
