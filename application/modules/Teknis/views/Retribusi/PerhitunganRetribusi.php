                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <select name="kepemilikan" class="form-control jenis-kepemilikan">
                          ...
                          <option value="1">Perorangan / Usaha</option>
                        </select>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 ket-bangunan">
                    <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <p class="form-control-static faktor-kepemilikan">0</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12 ket-bangunan">
              ...
              <div class="row">
                ...
                <div class="col-md-12 ket-bangunan">
                  <div class="form-group">
                    ...
                    <div class="col-md-2">
                      <input type="number" name="lokalitas" id="inputData" class="form-control" required>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-md-offset-10 col-md-9">
                      ...
                      <a href="<?php echo site_url('Teknis/Perhitungan') ?>" class="btn default">Kembali</a>
                    </div>
                  </div>
                </div>
  ...
  $(document).ready(function() {
    ...
    $(() => {
      let p = parseInt($('.radio-permanensi').filter(":checked").val()),
        ...
        yy = $('.jenis-kepemilikan').find(':selected').val();
        console.log(p);
      h(0.2 * p, yy);
      u(q);
    });
    ...
    let u = function(v, shst, vals) {
      let l = parseFloat($('.luas-bangunan').text().split(" ")[0]),
        ...
        n = $('#inputData').val() == '' ? 0 : parseFloat($('#inputData').val() / 10),
