        ...
        <div class="portlet box blue">
            ...
            <?php $this->load->view('HeaderData') ?>
                <div class="portlet box blue-hoki">
                    <div class="portlet-title"><div class="caption">Konfirmasi Pernyataan Permohonan</div></div>
                    <input type="hidden" class="form-control" value="<?php echo set_value('id', (isset($id) ? $id : '')) ?>" name="id" placeholder="id" autocomplete="off">
                    <form action="<?php echo site_url('KonsultasiOSS/saveDataPernyataan'); ?>" class="form-horizontal" role="form" method="post" id="FormPernyataan">
                        <input type="text" style="display: none;" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
                        <div class="note note-warning">
                            <h4 class="font-blue"><b>Sebelum anda mengkonfirmasi, Mohon memperhatikan informasi berikut:</b></h4>
                            <h5 class="font-blue">
                                <b>
                                    ...
                                    - Apabila terjadi kesalahan data setelah dilakukan konfirmasi, Anda dapat memperbaikinya setelah dikembalikan oleh Dinas Teknis
                                </b>
                            </h5>
                            <hr>
                            <b><h4 class="font-blue">Berdasarkan konfirmasi setuju yang saya nyatakan:</b>
                            <h5 class="font-blue">
                                <b>
                    ...
                    <center>
                        <div class="col-md-6">
                            <span class="input-group-btn">
                                ...
                                <button class="btn green" onClick="window.location.href = '<?php echo base_url(); ?>KonsultasiOSS/FormDataMEP/<?php echo $this->uri->segment(3); ?>';return false;">Kembali</button>
								<?php } else { ?>
								<button class="btn green" onClick="window.location.href = '<?php echo base_url(); ?>KonsultasiOSS/FormDataTeknis/<?php echo $this->uri->segment(3); ?>';return false;">Kembali</button>	
								<?php } ?>
							</span>
                        </div>
                        <div class="col-md-6">
