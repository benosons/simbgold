<div class="portlet light bordered margin-top-20">
	...
	<div class="portlet-body form">
		...
		<form action="<?php echo site_url('KonsultasiOSS/SaveData'); ?>" class="form-horizontal" role="form" method="post" id="from_biodata">
			...
			<div class="form-body">
				...
				<div id="identitas" style="display: none;">
					<div class="form-group" id="perorangan" style="display: none;">
						...
						<div class="col-md-3">
							<input type="text" class="form-control" value="<?php echo set_value('nama_pemilik', (isset($DataPemilik->nm_pemilik) ? $DataPemilik->nm_pemilik : '')) ?>" name="nama_pemilik" placeholder="Nama Lengkap Pemilik" autocomplete="off" readonly>
						</div>
						<div class="col-md-2">
				...
				<div class="form-group" id="nib" style="display: none;">
					...
					<div class="col-md-7">
						<input type="text" class="form-control" value="<?php echo set_value('no_nib', (isset($DataPemilik->no_ktp) ? $DataPemilik->no_ktp : '')) ?>" name="no_nib" placeholder="Nomor NIB" autocomplete="off" readonly>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<select name="nama_provinsi" id="nama_provinsi" class="form-control select2" data-placeholder="Select..." readonly>
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<select name="nama_kecamatan" id="nama_kecamatan" class="form-control select2" data-placeholder="Select..." readonly>
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<select name="nama_kelurahan" id="nama_kelurahan" class="form-control select2" data-placeholder="Select..." readonly>
...
<script>
	...
	$('#nama_provinsi').change(function() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>KonsultasiOSS/getDataKabKota/' + v,
	...
	$('#nama_kabkota').change(function() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>KonsultasiOSS/getDataKecamatan/' + v,
			data: $('form.form-horizontal').serialize(),
			success: function(response) {
				let data = JSON.parse(response);
				let csrf_token = data.csrf;
	...
	$('#nama_kecamatan').change(function() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>KonsultasiOSS/getDataKelurahan/' + v,
			data: $('form.form-horizontal').serialize(),
			success: function(response) {
				let data = JSON.parse(response);
				let csrf_token = data.csrf;
