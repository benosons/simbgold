		...
		<div class="portlet box blue">
			...
			<center>
				<span class="input-group-btn">
					<button class="btn green" onClick="window.location.href = '<?php echo base_url(); ?>Konsultasi/FormDataTanah/<?php echo $this->secure->encrypt_url($id); ?>';return false;">Kembali</button>
				</span>
				<span class="input-group-btn">
					<button class="btn green" onClick="window.location.href = '<?php echo base_url(); ?>Konsultasi/FormDataTeknis/<?php echo $this->secure->encrypt_url($id); ?>';return false;">Selanjutnya</button>
				</span>
			</center>
			<br>
		</div>
