							...
							<?php } else { ?>
								...
								<?php } else { ?>
									...
									<div class="row static-info">
										...
										<div class="col-md-8 value">
											<?php $queFungsi = $this->MDinasTeknis->get_jenis_fungsi_list($DataBangunan->id_fungsi_bg)->row();
					...
					<?php if ($retribusi->status_perhitungan != '1') { ?>
						...
						<div class="col-md-12 upload-retribusi">
							<div class="form-group">
								...
								<div class="col-md-4">
									<a href="javascript:void(0);" onClick="javascript:popWin('<?php echo base_url('file/Konsultasi/' . $id . '/SKRD/' . $retribusi->file_retribusi); ?>')" class="btn default btn-md blue-stripe">Dokumen Perhitungan</a>
								</div>
							</div>
						</div>
					<?php } else { ?>
