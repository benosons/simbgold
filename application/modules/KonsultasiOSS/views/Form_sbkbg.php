<div class="portlet light bordered margin-top-20">
	<div class="portlet-body form">
		...
		<form action="<?php echo site_url('Konsultasi/SaveSbkbg'); ?>" class="form-horizontal" role="form" method="post" id="FormSbkbg" enctype="multipart/form-data">
			<input type="hidden" class="form-control" value="<?php echo $id_bgn ?>" name="id_bgn" placeholder="id Bangunan" autocomplete="off">
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="date" class="form-control" name="tgl_imb" value="<?php echo set_value('tgl_imb', (isset($DataBangunan->tgl_imb) ? $DataBangunan->tgl_imb : '')) ?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label">Dokumen IMB</label>
					<div class="col-md-8">
						<div class="fileinput fileinput-new" data-provides="fileinput">
							<?php if (!empty($DataBangunan->dir_dokumen_imb)) {
								$filename = FCPATH . "/dekill/Konsultasi/$DataBangunan->dir_dokumen_imb";
								$file = '';
								if (file_exists($filename)) {
									$file = base_url('dekill/Konsultasi/' . $DataBangunan->dir_dokumen_imb);
								} else {
									$file = base_url() . 'file/Konsultasi/' . $DataBangunan->id_bgn . '/' . $DataBangunan->dir_dokumen_imb;
								}
								$name = 'Ubah Fle';
								...
								<input type="hidden" name="dir_dokumen_imb" value="<?= $DataBangunan->dir_dokumen_imb; ?>" id="dir_dokumen_imb">
							<?php } ?>
							<input type="file" name="dir_file_imb" id="dir_file_imb">
						</div>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-md-5">
						<div class="checkbox-list">
							<input type="text" class="form-control" maxlength="50" name="no_slf" value="<?php echo set_value('no_slf', (isset($DataBangunan->no_slf) ? $DataBangunan->no_slf : '')) ?>" placeholder="No SLF" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="date" class="form-control" name="tgl_slf" value="<?php echo set_value('tgl_slf', (isset($DataBangunan->tgl_slf) ? $DataBangunan->tgl_slf : '')) ?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label">Dokumen SLF</label>
					<div class="col-md-8">
						<div class="fileinput fileinput-new" data-provides="fileinput">
							<?php if (!empty($DataBangunan->dir_dokumen_slf)) {
								$filename = FCPATH . "/dekill/Konsultasi/$DataBangunan->dir_dokumen_slf";
								$file = '';
								if (file_exists($filename)) {
									$file = base_url('dekill/Konsultasi/' . $DataBangunan->dir_dokumen_slf);
								} else {
									$file = base_url() . 'file/Konsultasi/' . $DataBangunan->id_bgn . '/' . $DataBangunan->dir_dokumen_slf;
								}
								$name = 'Ubah Fle';
								echo '<div class="fileinput-new thumbnail">';
								echo '<a href="' . $file . '" target="_blank" alt="" class="btn default blue-stripe">Lihat</a>';
								...
								<input type="hidden" name="dir_dokumen_slf" value="<?= $DataBangunan->dir_dokumen_slf; ?>" id="dir_dokumen_slf">
							<?php } ?>
							<input type="file" name="dir_file_slf" id="dir_file_slf">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">Masa Berlaku SLF<span class="required">*</span></label>
					<div class="col-md-3">
						<input type="date" class="form-control" name="berlaku_tgl_slf" value="<?php echo set_value('berlaku_tgl_slf', (isset($DataBangunan->berlaku_tgl_slf) ? $DataBangunan->berlaku_tgl_slf : '')) ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<?php
						$list_jnsBgn = ['' => '-- Pilih --', '2' => 'Bangunan Gedung', '5' => 'Bangunan Prasarana'];
						echo form_dropdown('id_izin', $list_jnsBgn, !empty($DataBangunan->id_izin) ? $DataBangunan->id_izin : '', 'class ="form-control" id="id_izin" onchange="getjenisPermohonan(this.value)"'); ?>
					</div>
				</div>
				...
				<div id="fungsibg" style="display:none;">
					<div class="form-group">
						...
						<div class="col-md-7">
							<div class="col-md-3">
								...
								<table class="table table-striped table-bordered dt-responsive wrap" id="tipe_bgn">
									...
									<?php
									$tipe = json_decode(!empty($DataBangunan->tipeA) ? $DataBangunan->tipeA : '');
									$jumlah = json_decode(!empty($DataBangunan->jumlahA) ? $DataBangunan->jumlahA : '');
									$luas = json_decode(!empty($DataBangunan->luasA) ? $DataBangunan->luasA : '');
									$tinggi = json_decode(!empty($DataBangunan->tinggiA) ? $DataBangunan->tinggiA : '');
									$lantai = json_decode(!empty($DataBangunan->lantaiA) ? $DataBangunan->lantaiA : '');
									$bangunan = array();
									if (!empty($tipe))
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<div class="radio-list">
								<label><input type="radio" name="jual" value="1" <?= isset($DataBangunan->jual) == 1 ? 'checked' : ''; ?>> Iya</label>
								<label><input type="radio" name="jual" value="0" <?= isset($DataBangunan->jual) == 0 ? 'checked' : ''; ?>> Tidak</label>
							</div>
						</div>
					</div>
				</div>
				<div id="jns_bg_toggle" style="display:none;">
					<div class="form-group">
				...
				<div class="form-group">
					<label class="col-md-3 control-label">Dokumen Denah Situasi</label>
					<div class="col-md-8">
						<div class="fileinput fileinput-new" data-provides="fileinput">
							<?php if (!empty($DataBangunan->dir_dokumen_denah)) {
								$filename = FCPATH . "/dekill/Konsultasi/$DataBangunan->dir_dokumen_denah";
								$file = '';
								if (file_exists($filename)) {
									$file = base_url('dekill/Konsultasi/' . $DataBangunan->dir_dokumen_denah);
								} else {
									$file = base_url() . 'file/Konsultasi/' . $DataBangunan->id_bgn . '/' . $DataBangunan->dir_dokumen_denah;
								}
								$name = 'Ubah Fle';
								echo '<div class="fileinput-new thumbnail">';
								echo '<a href="' . $file . '" target="_blank" alt="" class="btn default blue-stripe">Lihat</a>';
								...
								<input type="hidden" name="dir_dokumen_denah" value="<?= $DataBangunan->dir_dokumen_denah; ?>" id="dir_dokumen_denah">
							<?php } ?>
							<input type="file" name="dir_file_denah" id="dir_file_denah">
						</div>
					</div>
				</div>
				<div class="form-group">
...
<script>
		...
		if ($("#id_izin").val() == 1) {
			if ($("#id_fungsi_bg").val() == 1) {
				if (luas_bg <= 100 && lantai_bg <= 2) {
					document.getElementById('per_doc_tek').style.display = "block";
					document.getElementById('prototype').style.display = "none";
					if ('<?= !empty($DataBangunan->id_doc_tek) ? $DataBangunan->id_doc_tek : ''; ?>' == 1) {
						select_tek = "selected";
					} else if ('<?= !empty($DataBangunan->id_doc_tek) ? $DataBangunan->id_doc_tek : ''; ?>' == 2) {
						select_tek2 = "selected";
					} else if ('<?= !empty($DataBangunan->id_doc_tek) ? $DataBangunan->id_doc_tek : ''; ?>' == 3) {
						select_tek3 = "selected";
					} else if ('<?= !empty($DataBangunan->id_doc_tek) ? $DataBangunan->id_doc_tek : ''; ?>' == 4) {
			...
			$('#id_doc_tek').html(id_doc_tek);
			Load_prototype('<?= !empty($DataBangunan->id_doc_tek) ? $DataBangunan->id_doc_tek : ''; ?>');
		}
	}
	/**
		...
		if (v == 6) {
			...
			$.ajax({
				...
				success: function(response) {
					...
					delete data.csrf;
					$.each(data, function(key, value) {
						if (value.id_jns_bg == '<?= !empty($DataBangunan->id_jns_bg) ? $DataBangunan->id_jns_bg : ''; ?>') {
							select = "selected";
						} else {
							select = "";
						}
	...
	function Load_prototype(v) {
		if (v == 2 || v == 3) {
			document.getElementById('prototype').style.display = "block";
			if ('<?= !empty($DataBangunan->id_prototype) ? $DataBangunan->id_prototype : ''; ?>' == 1) {
				select_1 = "selected";
			} else if ('<?= !empty($DataBangunan->id_prototype) ? $DataBangunan->id_prototype : ''; ?>' == 2) {
				select_2 = "selected";
			} else {
				var select_1 = '';
				var select_2 = '';
