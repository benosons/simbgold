<div class="row">
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title"><div class="caption">Data Pengajuan Konsultasi</div></div>
						...
						<?php if (!empty($DokumenUmum)) {
							...
							foreach ($DokumenUmum->result() as $key) {
								...
								<tr class="<?= $clss ?>">
									...
									<td align="center">
										<?php echo form_open_multipart('KonsultasiOSS/SaveDokumen/' . $id . '/' . $key->id_detail . '/5/' . $id_administrasi, array('name' => 'frmup' . $no, 'id' => 'frmup' . $no)); ?>
			...
			<center>
				...
				<span class="input-group-btn">
					<button class="btn green" onClick="window.location.href = '<?php echo base_url(); ?>KonsultasiOSS/FormDataTeknis/<?php echo $this->secure->encrypt_url($id); ?>';return false;">Selanjutnya</button>
				</span>
			</center>
			<br>
		</div>
