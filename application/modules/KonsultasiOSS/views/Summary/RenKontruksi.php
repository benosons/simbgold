...
<div class="portlet box blue-hoki">
  <div class="portlet-title">
    <div class="caption">
      Form Input Tanggal Rencana Kontruksi   </div>
  </div>
  <div class="portlet-body">
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-12">
            <form action="<?php echo site_url('Konsultasi/SimpanKon') ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
            <div class="form-body">
                <div class="col-md-12">
                    <div class="portlet-body">
                        <div class="row">
