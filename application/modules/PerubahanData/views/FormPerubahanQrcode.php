	...
	<div id="accordion_SK" class="panel-group">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h2 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_SK"><b>Rubah Data Permohonan PBG/SLF</b></a></h2>
			</div>
								...
								<table id="table_permohonan" class="table table-striped table-bordered">
									<thead>
										<tr>
											...
											<th width="35%">Status Permohonan</th>
											<th width="8%">Dokumen</th>
											<th width="8%">QrCode</th>
										</tr>
									</thead>
									<tbody></tbody>
								</table>
...
<div id="ModalHapus" class="modal fade" tabindex="-1" aria-hidden="true" data-width="30%" data-backdrop="static" data-keyboard="false">
	<div class="modal-content">
		<form action="<?php echo site_url('PerubahanData/CreateQrCode'); ?>" class="form-horizontal" role="form" method="post" id="frm_perubahan" enctype="multipart/form-data">
				...
				<div class="form-body">
					<div class="form-body">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-3">No Konsultasi<span class="required">*</span></label>
									<div class="col-md-9">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-danger btn-sm" ><i class="fa fa-trash-o"></i> Create QrCode</button>
			</div>
		</form>
	</div>
</div>
...
<script language="javascript" type="text/javascript">
	...
	function Registrasi() {
		...
		if (no_registrasi == "") {
			...
			$.ajax({
				type: "get",
				url: "<?php echo base_url(); ?>PerubahanData/CariQrcode/" + no_registrasi + "/1",
	...
	$('#btn_hapus').on('click', function() {
		...
		$.ajax({
			type: "get",
			url: "<?php echo base_url('PerubahanData/CreateQrCode') ?>",
			dataType: "JSON",
			data: {
				kode: kode
			},
