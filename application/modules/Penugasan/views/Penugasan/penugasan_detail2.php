	...
	<div class="col-md-12">
		<div class="portlet light">
			<div class="portlet-title">
				<h4 align="center" class="caption-subject font-red bold uppercase">Data Pokok Permohonan <?= (isset($row->no_konsultasi) ? $row->no_konsultasi : '') ?></h4>
				<hr />
				...
				<table class="table table-bordered table-striped table-hover">
					<tbody>
						<?php if (isset($id_pemanfaatan_bg) == 1) {
							$nama = 'Nama-nama TABG';
						} else {
						...
						if (isset($jmlPegawai) && $jmlPegawai > 0) {
							...
							for ($j = 0; $j < $jmlPegawai; $j++) { ?>
								<tr class='event' id="list_peg-<?= $j ?>">
									...
									<td><input type='hidden' name='id_peg-<?= $j ?>' id='id_peg-<?= $j ?>' value='<?= $result_peg[$j]['id_personal'] ?>'><?php echo $no++ ?></td>
									<?php
									...
									?>
									<td><input type='hidden' name='nama_peg-<?= $j ?>' id='nama_peg-<?= $j ?>' value='<?= $namapeg ?>'><?php echo $namapeg; ?></td>

									<td><input type='hidden' name='unsur-<?= $j ?>' id='unsur-<?= $j ?>' value='<?= $result_peg[$j]['nama_unsur'] ?>'><?php echo $result_peg[$j]['nama_unsur'] . ' - ' . $result_peg[$j]['nama_unsur_ahli']; ?></td>
									<td><input type='hidden' name='bidang-<?= $j ?>' id='bidang-<?= $j ?>' value='<?= $result_peg[$j]['nama_bidang'] ?>'><?php echo $result_peg[$j]['nama_bidang']; ?></td>
									<td><input type='hidden' name='keahlian-<?= $j ?>' id='keahlian-<?= $j ?>' value='<?= $result_peg[$j]['nama_keahlian'] ?>'><?php echo $result_peg[$j]['nama_keahlian']; ?></td>
				...
				<br>
				<h4 class="caption-subject font-red bold uppercase" align="center">Besar Retribusi Rp. <?php if (isset($harganya) == 0) {
																											echo '-';
																										} else {
																											echo number_format($harganya, 0, '', '.');
																										} ?> </h4>
