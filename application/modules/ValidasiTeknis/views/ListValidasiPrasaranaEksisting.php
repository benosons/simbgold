...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-globe"></i>List Validasi Kepala Dinas Teknis untuk Bangunan Prasarana Eksisting</div>
...
<div id="dialog-popup" class="modal fade bs-modal-sm" data-width="55%" tabindex="-1" aria-hidden="true" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-content">
        <form action="<?php echo site_url('ValidasiTeknis/FormVerifikasiPrasaranaEksisting'); ?>" class="form-horizontal" role="form" method="post">
...
<script>
    function GetCetakRekomtek(id) {
        var url = "<?php echo base_url() . index_page() ?>Dokumen/CetakVerifikasiBangunanEksisting/" + id;
        swin = window.open(url, 'win', 'scrollbars,width=1000,height=600,top=80,left=140,status=yes,toolbar=no,menubar=yes,location=no');
        swin.focus();
    }
    function GetVerifikasi(id) {
        $("#MyModalBody").html('<iframe src="<?php echo base_url(); ?>Dokumen/CetakVerifikasiBangunanEksisting/' + id + '" frameborder="no" width="860" height="540"></iframe>');
        $('[name="id"]').val(id);
    }
</script>
<script>
