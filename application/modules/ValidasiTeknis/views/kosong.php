			...
			<div class="col-md-12 ">
				<div class="form-body">
					<div class="form-group">
						...
						<div class="col-md-9">
                            <textarea type="text" class="form-control" name="catatan" placeholder="Alasan" autocomplete="off"><?php echo set_value('almt_bgn', (isset($DataBangunan->catatan) ? $DataBangunan->catatan : '')) ?></textarea>
                        </div>
					</div>
					<br>
				</div>
