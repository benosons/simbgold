...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-globe"></i>List Validasi Kepala Dinas Teknis untuk Bangunan Gedung Eksisting</div>
                        ...
                        <tr class="<?= $clss ?>">
                            ...
                            <?php if ($Kadis->status == 10) { ?>
                                <td align="center">
                                    ...
                                    <div class="data-action"></div><br>
                                    <?php if($Kadis->imb == 1){ ?>
                                        <a href="<?php echo site_url('ValidasiTeknis/RollbackKadisEksis/' . $Kadis->id); ?>" class="btn btn-warning btn-sm" onclick="return confirm('Yakin Mengembalikan Permohonan ini ke Proses Perhitungan Retribusi?')"title="Dikembalikan ke Proses Perhitungan Retribusi"><span class="glyphicon glyphicon-edit"></span>
                                    <?php }else{ ?>
                                        <a href="<?php echo site_url('ValidasiTeknis/RollbackKadisEksis/' . $Kadis->id); ?>" class="btn btn-warning btn-sm" onclick="return confirm('Yakin Mengembalikan Permohonan ini ke Proses Perhitungan Retribusi?')"title="Dikembalikan ke Proses Perhitungan Retribusi"><span class="glyphicon glyphicon-edit"></span>
                                    <?php } ?>
                                </td>
...
<div id="dialog-popup" class="modal fade bs-modal-sm" data-width="55%" tabindex="-1" aria-hidden="true" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-content">
        <form action="<?php echo site_url('ValidasiTeknis/FormVerifikasiEksisting'); ?>" class="form-horizontal" role="form" method="post">
