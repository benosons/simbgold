...
<form action="<?php echo site_url('Sekretariat/saveDataPendidikan'); ?>" class="form-horizontal" role="form" method="post" id="Form_Data_Pendidikan" enctype="multipart/form-data">
	<div class="col-md-12 ">
	<!--<input type="hidden" class="form-control" value="<?php echo set_value('id_riwpend', (isset($DataPersonil->id_riwpend) ? $DataPersonil->id_riwpend : '')) ?>" name="id" placeholder="ID Pendidikan" autocomplete="off">-->		
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input type="text" class="form-control" value="<?php echo set_value('alamat_skl', (isset($DataPersonil->alamat_skl) ? $DataPersonil->alamat_skl : '')) ?>" name="alamat_skl" placeholder="Kota Asal Sekolah / Perguruan Tinggi" autocomplete="off">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input type="text" class="form-control yearpicker" value="<?php echo set_value('thn_lulus', (isset($DataPersonil->thn_lulus) ? $DataPersonil->thn_lulus : '')) ?>" name="thn_lulus" placeholder="Tahun Kelulusan" autocomplete="off" onkeydown="return false" >
...
<script type="text/javascript">
	...
	function getjurusan(v) {
		jQuery.post(base_url + 'pupr/getDataJurusan/' + v, function(data) {
			var nama_jurusan = '';
