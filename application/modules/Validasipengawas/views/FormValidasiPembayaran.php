<div class="modal-body">
	<div class="row">
		<div class="col-md-12">
			<div class="portlet light">
				<div class="portlet-title">
					...
					<?php if ($databgn->id_jenis_permohonan == '11') { ?>
						<div class="row static-info">
					...
					<?php } else { ?>
						...
						<?php else : ?>
							<div class="row static-info">
								...
								<div class="col-md-8 value">
									<?php
									$oldFIle = FCPATH . 'file/konsultasi/' . $databgn->id . '/retribusi/berkas_retribusi/' . $databgn->file_retribusi;;
									$dir = '';
									if (file_exists($oldFIle)) {
										$dir = 'file/konsultasi/' . $id . '/retribusi/berkas_retribusi/' . $databgn->file_retribusi;
									} else {
										$dir = 'dekill/Retribution/' . $databgn->file_retribusi;
									} ?>
		...
		<!-- Begin Penagihan -->
		<div class="col-md-12">
			<form action="<?php echo site_url('Penerbitan/FormSSRD/' . $id); ?>" class="form-horizontal" role="form" method="post" id="ss_rd" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<div class="input-group">
										...
										<?php $filename = FCPATH . "/dekill/Retribution/$retribusi->dir_file_penagihan";
										$dir = '';
										if (file_exists($filename)) {
											$dir_bayar = base_url('dekill/Retribution/' . $retribusi->dir_file_penagihan);
										} else {
											$dir_bayar = base_url('file/Konsultasi/' . $id . '/SKRD/' . $retribusi->dir_file_penagihan);
										} ?>
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
										<input name="tgl_pembayaran" class="form-control" value='<?php echo set_value('tgl_pembayaran', (isset($retribusi->tgl_pembayaran) ? $retribusi->tgl_pembayaran : '')) ?>' id="tgl_pembayaran" type="text" placeholder="2000-12-20" readonly>
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-file-pdf-o"></i></span>
										<?php $filename = FCPATH . "/dekill/Retribution/$retribusi->bukti_pembayaran";
											$dir = '';
											if (file_exists($filename)) {
												$dir_bukti = base_url('dekill/Retribution/' . $retribusi->bukti_pembayaran);
											} else {
												$dir_bukti = base_url('file/Konsultasi/' . $id . '/retribusi/' . $retribusi->bukti_pembayaran);
											} ?>
