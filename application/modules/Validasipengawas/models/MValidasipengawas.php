...
class MValidasipengawas extends CI_Model{
	//Begin Data Summary
	...
	public function  getListPenyerahan()
	{
		...
		$this->db->where("b.id_jenis_permohonan != 14 ");
		if($Dinas =='31'){
			$this->db->where('id_prov_bgn = 31');
			$this->db->where('jml_lantai > 8');
		}else if ($Dinas =='3101' || $Dinas =='3171' || $Dinas =='3172' || $Dinas =='3173' || $Dinas =='3174' || $Dinas =='3175'){
			$this->db->where('id_kabkot_bgn', $Dinas);
			$this->db->where('jml_lantai < 9');
		}else {
			$this->db->where('id_kabkot_bgn', $Dinas);
		}
	...
	function getdatabangunanDok($id='null')
	{
		$sql = "SELECT a.id,
				...
				b.tipeA,b.luasA,b.tinggiA,b.lantaiA,b.jumlahA,b.luas_bgp,b.status,
				c.nama_kelurahan,
				d.nama_kecamatan,
				e.nama_kabkota,
				f.nama_provinsi,
	...
	function getdatabangunanDokSLF($id='null')
	{
		$sql = "SELECT a.id,
				...
				b.jml_lantai,b.tipeA,b.luasA,b.tinggiA,b.lantaiA,b.jumlahA,b.no_imb,b.status,
				c.nama_kelurahan,
				d.nama_kecamatan,
				e.nama_kabkota,
				f.nama_provinsi,
