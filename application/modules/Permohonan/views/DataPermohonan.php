<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>List Data Permohonan</div>
		<div class="tools"><a href="javascript:;" class="reload"></a></div>
	</div>
	<div class="portlet-body">
		<div class="form-actions">
			<?php echo form_open('Permohonan/Konsultasi', array('name' => 'frmListVerifikasi', 'id' => 'frmListVerifikasi')); ?>
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-9">
							<div class="col-md-12">
								...
								<a href="<?php echo base_url('Permohonan/cetak_excel/'.$fungsi.'/'.$awal.'/'.$akhir);?>"  title="cetak" class="btn green">Cetak Excel</a>
							</div>
						</div>
					</div>
				</div>
				...
				<?php if ($Verifikasi->num_rows() > 0) {
					...
					foreach ($Verifikasi->result() as $Konsultasi) { ?>
						...
						<tr class="<?= $clss ?>">
							...
							<td><?php echo $Konsultasi->nama_provinsi; ?></td>
							<td><?php echo $Konsultasi->nama_kabkota; ?></td>
