<div class="portlet box blue">
	...
	<div class="portlet-body">
		<div class="form-actions">
			<?php echo form_open('Permohonan/MonHapus', array('name' => 'frmListVerifikasi', 'id' => 'frmListVerifikasi')); ?>
			<div class="row">
				<div class="col-md-12">
				...
				<?php if ($Verifikasi->num_rows() > 0) {
					...
					foreach ($Verifikasi->result() as $Konsultasi) { ?>
						...
						<tr class="<?= $clss ?>">
							...
							<td align="center">
                                <a href="<?php echo site_url('Permohonan/removeDataPengajuan/' . $Konsultasi->id); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ini?')" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></a>
							</td>
						</tr>
				<?php }
				} ?>
