	...
	<div class="portlet-body">
		...
		<div id="pluspersonil" style="display: block;">
			...
			<div class="portlet box blue">
				...
				<div class="portlet-body">
					<form action="<?php echo site_url('TenagaAhli/Savedatadiri'); ?>" class="form-horizontal" role="form" method="post" id="FormDataDiri" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<select class="form-control select" name="id_jabatan">
									...
									<option value="1" <?php if ($Dataaka->id_jabatan == '1') echo "selected"; ?>>Lektor</option>
									<option value="2" <?php if ($Dataaka->id_jabatan == '2') echo "selected"; ?>>Lektor Kepala</option>
									<option value="3" <?php if ($Dataaka->id_jabatan == '3') echo "selected"; ?>>Guru Besar</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label">Jenis Kelamin<?php echo $Dataaka->jns_kelamin; ?></label>
							<div class="col-md-3">
		...
		$("#FormDataDiri").validate({
			...
			messages: {
				...
				no_kontak: {
					...
					minlength: "Nomor Telp/HP minimal 11 karakter",
