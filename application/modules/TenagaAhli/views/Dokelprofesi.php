		...
		<div id="pluspersonil" style="display: block;">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption">Dokumen Kelengkapan</div>
				</div>
				<div class="portlet-body">
					<form action="<?php echo site_url('TenagaAhli/saveDokumen'); ?>" class="form-horizontal" role="form" method="post" id="FormDok" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Nama Asosiasi Profesi</label>
							<div class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<?php if ($DataTpa->dir_file != '' || $DataTpa->dir_file != null) {
					...
					<center>
						...
						<span class="input-group-btn">
							<button class="btn green" onClick="window.location.href = '<?php echo base_url(); ?>TenagaAhli/Datadiri';return false;">Selanjutnya</button>
						</span>
					</center>
				</div>
			</div>
