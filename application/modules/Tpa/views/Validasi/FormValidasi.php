										...
										if($DataPendidikan->num_rows() > 0){
											foreach($DataPendidikan->result() as $dtp){ ?>
												<tr class="list_<?= $dtp->id_riwpend; ?>">
													...
													<td><?= $dtp->no_ijazah; ?></td>
													<td><a href="javascript:void(0);" onClick="javascript:popWin('<?php echo base_url('file/Pendidikan/' . $dtp->id_riwpend . '/' . $dtp->dir_file); ?>')" class="btn default btn-xs blue-stripe">Lihat</a></td>
												</tr>
											<?php }
										} ?>
									</tbody>
								...
								<table class="table table-bordered table-striped table-hover" id="sample_editable_1">
									<thead>
										<tr class="warning">
											...
											<th><center>Spesialist</center></th>
											<th><center>Kualifikasi SKA</center></th>
											<th><center>No. SKA</center></th>
											<th><center>Berkas</center></th>
											</th>
										</tr>
									</thead>
										...
										if($DataAhli->num_rows() > 0){
											foreach($DataAhli->result() as $dtk){ 
												...
												<tr class="list_<?= $dtk->id_ahli; ?>">
													...
													<td></td>
													<td></td>
													<td><a href="javascript:void(0);" onClick="javascript:popWin('<?php echo base_url('file/Pendidikan/' . $dtk->id_ahli . '/' . $dtk->dir_file); ?>')" class="btn default btn-xs blue-stripe">Lihat</a></td>
												</tr>
											<?php }
										} ?>
									</tbody>
