        ...
        <?php if ($tpa_result->num_rows() > 0) {
          ...
          foreach ($tpa_result->result() as $key) { ?>
            ...
            ?>
                ...
                <td align="center">
                    <?php if($key->status =='1'){ ?>
                        <a href="<?php echo site_url('Tpa/VerifikasiProvForm/' . $key->id); ?>" class="btn btn-success btn-sm" title="Ubah Data Personil" data-toggle="modal" data-target="#static"><span class="glyphicon glyphicon-edit"></span></a>
                    <?php } else { ?>
