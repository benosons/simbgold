		...
		<form action="<?php echo site_url('DataSetting/saveDataPersyaratanKonsultasi');?>" class="form-horizontal" role="form" method="post" id="form_edit_persyaratan_permohonan">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title">Form Ketentuan Teknis</h4>
				</div>
						...
						<div class="col-md-12 ">
							<div class="portlet box grey-cascade">
								<div class="portlet-title">
									<div class="caption">
										<i class="fa fa-gift"></i>Pengaturan Ketentuan Teknis Konsultasi
									</div>
									<div class="tools">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<div>
													...
													?>
													<input type="text" class="form-control" id="nama_permohonan" value="<?php echo $jenis_permohonan->row()->nm_konsultasi?>" name="nama_permohonan" placeholder="Nama Permohonan" autocomplete="off" disabled>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="col-md-12 ">
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									<?php
									$element = 'checkbox';
									if($query_syarat_adm->num_rows() > 0):
...
<script type="text/javascript">
	var id = $('#id').val();
	jQuery.post(base_url+'DataSetting/listPersyaratanAdmShow',{value:id,disable:'N'},function(data){
