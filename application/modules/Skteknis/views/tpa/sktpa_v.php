                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a href="<?php echo site_url('skteknis/pengaturan_sktpa_edit/' . $r->id_skta); ?>" class="btn btn-success btn-sm" title="Ubah Data Personil" data-toggle="modal" data-target="#modal-edit-personal"><span class="glyphicon glyphicon-user"></span></a></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo site_url('skteknis/sktpa_delete/' . $r->id_skta); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ini?')" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></a>
                                </td>
                            </tr>
                    <?php
                        }
...
<div id="responsive" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog" data-backdrop="static" data-keyboard="false">
    <?php echo form_open_multipart('skteknis/sktpa_save', [
    ...
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            <h4 class="modal-title">Form Data SK TPA</h4>
        </div>
...
<script>
    ...
    function ubahSkta(id) {
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('skteknis/sktpa_edit/') ?>",
            dataType: "JSON",
            data: {
                id: id
            },
    ...
    function getPdf(id) {
        url = "<?php echo base_url() . index_page() ?>public/uploads/pupr/sk/sktpt/" + id;
