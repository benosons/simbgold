<form action="<?php echo site_url('skteknis/pengaturan_sktpa_save'); ?>" class="form-horizontal" role="form" method="post" id="form_edit_sktabg">
	<div class="modal-body">
		<div class="form-group">
			<label class="bold uppercase"> Nomor SK <?php echo set_value('no_skta', (isset($row->no_skta) ? $row->no_skta : '')) ?></label>
			<input type="hidden" class="form-control" id="id" value="<?php echo set_value('id_skta', (isset($row->id_skta) ? $row->id_skta : '')) ?>" name="id" placeholder="id" autocomplete="off">
		</div>
		<div class="form-group">
			<?php
			$element = 'checkbox';
