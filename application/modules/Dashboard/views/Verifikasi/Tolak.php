<form action="<?php echo site_url('Dashboard/SimpanTolak'); ?>" class="form-horizontal" role="form" method="post" id="savestatussyarat" name="savestatussyarat" enctype="multipart/form-data">
    ...
    <div class="modal-header">
		...
		<h4 align="center" class="modal-title"><b>Alasan Penolakan</b></h4>
	</div>
