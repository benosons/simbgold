				...
				<div class="col-md-12 ">
					<div class="form-body">		
						...
						<ol><br>
                            ...
                            <li>Pada Menu Dinas Teknis , yang ditampilkan pada List Verifikasi hanya yang belum di Verifikasi oleh Operator Dinas Teknis, Untuk Permohonan yang sudah di Verifikasi bisa di lihat pada Menu Monitoring<br>
                            <br>
                        </ol>
					</div>
					<br>
