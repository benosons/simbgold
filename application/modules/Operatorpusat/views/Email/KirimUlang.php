...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-globe"></i>List Pendaftaran Permohonan Akun Untuk Bangunan Gedung</div>
		...
		<table class="table table-striped table-bordered table-hover" id="sample_1">
			...
			<tbody>
				...
				foreach ($User as $r) { ?>
					...
					if ($r->role_id == 10) {
						$nama_role = "Pemohon";
					} else if($r->role_id == 17){
                        $nama_role = "Calon TPA";
                    }else{
						$nama_role = "Belum Diktehui";
					}
					?>
					<tr>
						<td align="center"><?php echo $no++; ?></td>
						<td><?php echo $r->email; ?></td>
						<td align="center"><?php echo $nama_role; ?></td>
						<td align="center"><?php echo $r->post_date; ?></td>
						<td align="center">
							<a href="<?php echo site_url('Operatorpusat/KirimEmail/' . $r->id); ?>" class="btn btn-success btn-sm" title="Membuat Akun TPT/Penilik" data-toggle="modal" data-target="#static"><span class="glyphicon glyphicon-edit"></span></a>		
						</td>
					</tr>
				<?php } ?>
			</tbody>
