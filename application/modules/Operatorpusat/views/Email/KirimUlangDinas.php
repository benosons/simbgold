...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-globe"></i>List Akun Dinas Seluruh Indonesia</div>
			...
			<tbody>
				...
				foreach ($User as $r) { ?>
					...
					<tr>
						...
						<td align="center"><?php echo $r->name_role; ?></td>
                        <td align="center"><?php echo $r->nama_kabkota; ?></td>
                        <td align="center"><?php echo $status; ?></td>
						<td align="center"><?php echo $r->post_date; ?></td>
						<td align="center">
							<a href="<?php echo site_url('Operatorpusat/KirimEmailDinas/' . $r->id); ?>" class="btn btn-success btn-sm" title="Membuat Akun TPT/Penilik" data-toggle="modal" data-target="#static"><span class="glyphicon glyphicon-edit"></span></a>		
						</td>
					</tr>
				<?php } ?>
			</tbody>
