...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-globe"></i>List Data  Bangunan Eksisting</div>
    ...
    <div class="portlet-body">
        <table class="table table-striped table-bordered table-hover" id="sample_1">
            ...
            <tbody>
                <?php if ($Delete->num_rows() > 0) {
                    $no = 1;
                    foreach ($Delete->result() as $Kadis) { ?>
                        <tr class="warning">
                            ...
                            <td></td>
                            <td align="center">
                                <a href="<?php echo site_url('Operatorpusat/FormDeleteEksis/' . $Kadis->id); ?>" class="btn btn-success btn-sm" title="Hapus Permohonan" data-toggle="modal" data-target="#static"><span class="glyphicon glyphicon-edit"></span></a>		
                            </td>
                        </tr>
                <?php }
                } ?>
