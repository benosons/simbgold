      ...
      <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="<?php echo site_url('Konsultasi') ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
              <div class="form-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12 ket-bangunan">
                            <div class="form-group">
                              ...
                              <div class="col-md-8">
                                <?php if ($row->luas_bgn >= 100){ 
                                  $klasifikasi_bg = 'Tidak Sederhana';
                                }else {
                                  $klasifikasi_bg = 'Sederhana';
                                }?>
                                <p class="form-control-static"><?php echo $klasifikasi_bg; ?></p>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-12 ket-bangunan">
                        ...
                        <div class="row">
                          <div class="col-md-12 ket-bangunan">
                            <div class="form-group">
                              ...
                              <div class="col-md-3">
                                <p class="form-control-static parameter-fungsi"><?php echo $row->index_parameter == NULL ? 0.7 : $row->index_parameter; ?></p>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12 ket-bangunan" style="padding-top:10px;">
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <input type="number" name="shst" id="shst" class="shst-input form-control" placeholder="Masukkan Nlai SHST"></select>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12 ket-bangunan">
