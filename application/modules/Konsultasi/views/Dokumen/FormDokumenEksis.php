			...
			<div class="col-md-12 ">
				<div class="form-body">
					...
					<?php }else if($Konsultasi->status == '15' || $Konsultasi->status == '16' || $Konsultasi->status == '17' || $Konsultasi->status == '18' || $Konsultasi->status == '19' || $Konsultasi->status == '20'){?>
						<div class="form-group">
							<label class="col-md-9 control-label">1. Dokumen Sertifikat Laik Fungsi</label><a href="#" onclick="GetCetakSertifikatLaikFungsi(<?php echo $id ?>)" class="btn btn-info btn" title="Cetak Persetujuan Bangunan Gedung" id="tombolinver"><span class="glyphicon glyphicon-print"> Lihat</span></a>
						</div>
