	...
	<div class="col-md-12">
		<div class="portlet box blue">
			...
			<div class="portlet box blue">
				...
				<!-- End Data Teknis MEP-->
				<center>
					<?php if($DataBangunan->id_jenis_permohonan =='8' || $DataBangunan->id_jenis_permohonan =='10'){ ?>
						<span class="input-group-btn">
							<button class="btn green" onClick="window.location.href = '<?php echo base_url(); ?>Konsultasi/FormDataMEP/<?php echo $id; ?>';return false;">Kembali</button>
						</span>
					<?php } else { ?>
						<span class="input-group-btn">
