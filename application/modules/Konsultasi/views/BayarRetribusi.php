...
<div class="portlet box blue-hoki">
  <div class="portlet-title">
    <div class="caption">Form Pembayaran Retribusi</div>
  </div>
  <div class="portlet-body">
    <form action="<?php echo site_url('Konsultasi/bayar_retribusi'); ?>" class="form-horizontal" role="form" method="post" id="pss_rd" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="portlet box green">
                      <div class="portlet-title">
                        <div class="caption"><i class="fa fa-edit"></i> Hasil Perhitungan Indeks Terintegrasi</div>
                      </div>
                      <div class="portlet-body" style="max-height:250px;height:250px;">
                        <div class="row">
                          <div class="col-md-12 ket-bangunan">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12 ket-bangunan">
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <p class="form-control-static shst">Rp. <?php echo number_format(str_replace('.', ',', $shst->shst)) ?></p>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12 ket-bangunan">
                        ...
                        <div class="col-md-12 ket-bangunan" style="padding-top:10px;">
                          <div class="form-group">
                            <label class="control-label col-md-4" style="text-align:left;">SHST</label>
                            <div class="col-md-4">
                              <input type="number" name="shst" id="shst" class="shst-input form-control" placeholder="Masukkan Nlai SHST">
                              </select>
                            </div>
                          </div>
                        </div>
                        ...
                        <?php if ($DataBangunan->status > 11) : ?>
                          <div class="col-md-12 pembayaran-retribusi">
                            <div class="form-group">
                              <label class="control-label col-md-4" style="text-align:left;">Nilai Pembayaran Retribusi</label>
                              <div class="col-md-4">
                                <input type="number" name="pembayaran" id="pembayaran" class="pembayaran-input form-control" placeholder="Masukkan Pembayaran Retribusi">
                                </select>
                              </div>
                            </div>
                          </div>
                        ...
                        <?php if ($DataBangunan->status > 11) : ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <?php echo anchor("Konsultasi/Lihat_SKRD", "<i class='fa fa-eye'></i> Lihat SKRD", ["class" => "btn btn-primary"]) ?>
                            </div>
                          </div>
                        </div>
                          <div class="col-md-12 upload-retribusi">
