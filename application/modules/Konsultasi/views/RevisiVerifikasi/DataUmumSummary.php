								...
								<tr class="<?= $clss ?>">
									...
									<?php if ($status_ver !='1'){ ?>
										...
										<?php } else { ?>
											...
											|
											<a href="<?php echo site_url('Konsultasi/DeleteTeknisRevMEP/' . $id_administrasi . '/tek/' . $id); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ini?')" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></a>
										<?php } ?>
