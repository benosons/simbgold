		...
		<div id="pluspersonil" style="display: block;">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption">Data Diri Tenaga Profesional Ahli</div>
				</div>
				<div class="portlet-body">
					<form action="<?php echo base_url('InputTPA/Savedatadiri'); ?>" class="form-horizontal" role="form" method="post" id="FormDataDiri" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-5"><input type="text" class="form-control" value="Akademisi" readonly disable></div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label">Nama Lengkap</label>
							<input type="hidden" class="form-control" value="<?php echo set_value('id', (isset($Dataaka->id) ? $Dataaka->id : '')) ?>" name="id" placeholder="Nama Lengkap" autocomplete="off">
							<input type="hidden" class="form-control" value="<?php echo set_value('id_user', (isset($Dataaka->id_user) ? $Dataaka->id_user : '')) ?>" name="id_user">
							<input type="hidden" class="form-control" value="<?php echo set_value('id_lembaga', (isset($Dataaka->id_lembaga) ? $Dataaka->id_lembaga : '1')) ?>" name="id_lembaga" placeholder="Gelar Depan" autocomplete="off">
							<div class="col-md-2"><input type="text" class="form-control" value="<?php echo set_value('glr_depan', (isset($Dataaka->glr_depan) ? $Dataaka->glr_depan : '')) ?>" name="glr_depan" placeholder="Gelar Depan" autocomplete="off"></div>
							<div class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" value="<?php echo set_value('nidn', (isset($Dataaka->nidn) ? $Dataaka->nidn : '')) ?>" name="nidn" placeholder="NIDN" autocomplete="off">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" class="form-control" value="<?php echo set_value('nip', (isset($Dataaka->nip) ? $Dataaka->nip : '')) ?>" name="nip" placeholder="NIP" autocomplete="off">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<select class="form-control select" name="id_jabatan">
									...
									<option value="1" <?php if (isset($Dataaka->id_jabatan) == '1') echo "selected"; ?>>Lektor</option>
									<option value="2" <?php if (isset($Dataaka->id_jabatan) == '2') echo "selected"; ?>>Lektor Kepala</option>
									<option value="3" <?php if (isset($Dataaka->id_jabatan) == '3') echo "selected"; ?>>Guru Besar</option>
								</select>
							</div>
						</div>
						<div class="form-group">
...
<script>
	...
	$("#FormDataDiri").validate({
		...
		highlight: function(element) {
			...
			// $("#csrf_id").load(location.href + " #csrf_id");
		},
