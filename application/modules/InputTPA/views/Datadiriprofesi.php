		...
		<div id="pluspersonil" style="display: block;">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption">
						Data Diri Ahli Profesi
					</div>
				</div>
				<div class="portlet-body">
					<form action="<?php echo site_url('InputTPA/simpandatadiri'); ?>" class="form-horizontal" role="form" method="post" id="FormDataDiri" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" value="Profesi" readonly disable>
							</div>
						</div>
						<div class="form-group">
							...
							<input type="hidden" class="form-control" value="<?php echo set_value('id_lembaga', (isset($Dataaka->id_lembaga) ? $Dataaka->id_lembaga : '3')) ?>" name="id_lembaga" placeholder="Gelar Depan" autocomplete="off">
							<div class="col-md-2">
							...
							<div class="col-md-9">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<?php if (isset($Dataaka->dir_keahlian) != '') {
										$filename = FCPATH . "/dekill/Tpa/$Dataaka->dir_keahlian";
										$file = '';
										if (file_exists($filename)) {
											$file = base_url('dekill/Tpa/' . $Dataaka->dir_keahlian);
										} else {
											$file = base_url() . 'file/Tpa/' . $Dataaka->id . '/' . $Dataaka->dir_keahlian;
										}
										$name = 'Ubah Fle';
										echo '<div class="fileinput-new thumbnail">';
										echo '<a href="' . $file . '" target="_blank" alt="" class="btn default blue-stripe">Lihat</a>';
							...
							<div class="col-md-9">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<?php if (isset($Dataaka->dir_sub) != '') {
										$filename = FCPATH . "/dekill/Tpa/$Dataaka->dir_sub";
										$file = '';
										if (file_exists($filename)) {
											$file = base_url('dekill/Tpa/' . $Dataaka->dir_sub);
										} else {
											$file = base_url() . 'file/Tpa/' . $Dataaka->id . '/' . $Dataaka->dir_sub;
										}
										$name = 'Ubah Fle';
										echo '<div class="fileinput-new thumbnail">';
										echo '<a href="' . $file . '" target="_blank" alt="" class="btn default blue-stripe">Lihat</a>';
...
<script>
	...
	// 			let csrf_token = response.csrf;
	// 			$('#csrf_id').val(csrf_token);
	// 		},
	// 		error: function(error) {
	// 			let csrf_error = error.csrf;
	// 			$('#csrf_id').val(csrf_error);
	// 		}
	// 	});
	// });
