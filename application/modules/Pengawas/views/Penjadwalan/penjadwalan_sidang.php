                        ...
                        <div class="col-md-3">
                            <div class="form-group form-md-line-input">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="sidang_ke" class="form-control" value="<?= $nextSidang ?>" readonly>
                        ...
                        <div class="col-md-5">
                            <div class="form-group form-md-line-input">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="thnDatePicker" autocomplete="off" onkeydown="return false" name="tanggal_sidang" type="text" data-date-format="yyyy-mm-dd" placeholder="Tanggal Konsultasi" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-md-line-input">
                                <div class="input-group">
                                    ...
                                    <input name="jam_sidang" class="form-control" value='' id="jam_sidang" type="text" placeholder="00.00">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <tbody>
                            <tr class="info">
                                ...
                                <th><center>Tanggal dan Jam</center></th>
                            ...
                            ?>
                                <tr id="record">
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo tgl_eng_to_ind($r->tgl_konsultasi) ?><br><?php echo $r->jam_konsultasi ?></td>
                                    <td><?php echo $r->ket_konsultasi ?></td>
                                    <td align="center">
                                        <a href="javascript:void(0);" class="btn btn-success btn-sm" title="Lihat Berkas" onClick="javascript:popWin('<?php echo base_url('file/PBG/' . $id . '/sidang/undangan_sidang/' . $r->dir_file_undangan); ?>')"><span class="glyphicon glyphicon-file"></span></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
