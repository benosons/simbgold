<div class="portlet box blue">
  <div class="portlet-title">
    <div class="caption"><i class="fa fa-globe"></i> Penjadwalan Konsultasi Bangunan Bertahap</div>
      ...
      <tbody>
        ...
        ?>
          <tr class="<?= $bgcolor ?>">
            ...
            <td align="left"><?php echo $pbg->no_konsultasi; ?></td>
        ...
        <div class="col-md-12">
          <div class="portlet-title">
            ...
            <div class="bangunan-spbu" style="display:none;">
              <div class="row static-info">
                <div class="col-md-4 name">Fungsi Bangunan Gedung</div>
                <div class="col-md-8 value jenis-prasarana"></div>
              </div>
              <div class="row static-info">
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response.res == true) {
            ...
            $(".luas-tinggi-spbu").html(`${response.luas_bgp} m<sup>2</sup>, dengan tinggi ${response.tinggi_bgp} meter.`);
            ...
            } else if (response.id_jenis_permohonan == 21) {
              $('.bangunan-kolektif').css('display', 'none');
              $('.fungsi-bangunan').css('display', 'none');
              $('.prasarana').css('display', 'none');
              $('.bangunan-spbu').css('display', 'block');
            ...
            jadwal.forEach(obj => {
              ...
              konsul.append(`<tr>
                ...
                <td><a href="javascript:void(0);" class="btn btn-success btn-sm" title="Lihat Berkas" onclick="javascript:popWin('${base_url}Dekill/Schedule/${obj.dir_file_undangan}')"><span class="glyphicon glyphicon-file"></span></a></td>
                </tr>`);
            });
