        ...
        <div class="form-wizard">
          <div class="form-body">
            <ul class="nav nav-pills nav-justified steps">
              ...
              <?php
              $finalisasi = $group == 0 ? '2' : '5';
              $tahapAkhir = $group == 0 ? '3' : '6';
              if ($group !== 0) : ?>
                <li>
                ...
                <li>
                  <a href="#tab3" data-toggle="tab" data-step="2" class="step">
                    ...
                    <span class="desc">
                      <i class="fa fa-check"></i>Pemeriksaan MEP</span>
                  </a>
                </li>
              <?php endif; ?>
              <li>
                <a href="#tab4" data-toggle="tab" data-step="4" class="step">
                  <span class="number"> <?= $finalisasi ?> </span>
                  <span class="desc">
                    <i class="fa fa-check"></i>BGH</span>
                </a>
              </li>
              <li>
                <a href="#tab5" data-toggle="tab" data-step="3" class="step">
                  <span class="number"> <?= $finalisasi ?> </span>
                  <span class="desc">
              ...
              <li>
                <a href="#tab6" data-toggle="tab" data-step="5" class="step">
                            ...
                            <table class="table table-bordered table-striped table-hover">
                              <thead>
                                <tr>
                                  ...
                                  <th rowspan="2" class="info" width="12%">
                                    <center>Aksi</center>
                                  </th>
                                </tr>
                                <tr>
                              ...
                              <table class="table table-bordered table-striped table-hover">
                                <thead>
                                  <tr>
                                    ...
                                    <th rowspan="2" class="info" width="10%">
                                      2 <center>Aksi</center>
                                    </th>
                                  </tr>
                                  <tr>
                                    <th class="info" colspan="3">Detail</th>
                    ...
                    <div class="portlet box blue">
                      ...
                      <div class="portlet-body">
                        <form action="#" role="form" method="post" class="final-identity form-horizontal" id="formFourth">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-7">
                              <select name="jns_kepemilikan" id="jenisKepemilikan" class="form-control">
                                ...
                                <option value="3">Perorangan/Usaha</option>
                              </select>
                            </div>
                          </div>

                          <div id="formPemerintah" style="display: none;">
                            <div class="form-group">
                              <label class="col-md-3 control-label">Unit Organisasi</label>
                              <div class="col-md-7">
                                <input type="text" class="form-control" name="unit_organisasi" id="unitOrganisasi" placeholder="Organisasi" autocomplete="off">
                              </div>
                            </div>
                          </div>

                          <div id="formIdentitas" style="display: none;">
                            <div class="form-group">
                              <label class="col-md-3 control-label">Nama Lengkap</label>
                              <div class="col-md-2">
                                <input type="text" class="form-control" id="gelarDepan" name="glr_depan" placeholder="Gelar" autocomplete="off">
                              </div>
                              <div class="col-md-3">
                                <input type="text" class="form-control" id="namaPemilik" name="nama_pemilik" placeholder="Nama Lengkap Pemilik" autocomplete="off">
                              </div>
                              <div class="col-md-2">
                                <input type="text" class="form-control" id="gelarBelakang" name="glr_belakang" placeholder="Gelar" autocomplete="off">
                              </div>
                            </div>

                            <div class="form-group" id="jenisPengenal">
                          ...
                          <div class="form-group" id="formNIB" style="display: none;">
                            <label class="col-md-3 control-label">No. NIB</label>
                            <div class="col-md-7">
                              <input type="text" class="form-control" name="nib" id="noNIB" placeholder="Nomor NIB" autocomplete="off">
                            </div>
                          </div>

                          <div class="form-group" id="formBadanUsaha" style="display: none;">
                            <label class="col-md-3 control-label">Nama Badan Usaha/Perusahaan</label>
                            <div class="col-md-7">
                              <input type="text" class="form-control" id="namaBadanUsaha" name="nm_pemilik" placeholder="Nama Badan Usaha/Perusahaan" autocomplete="off">
                            </div>
                          </div>

                          <div class="form-group">
                            <label class="col-md-3 control-label">Alamat<span class="required">*</label>
                            <div class="col-md-7">
                              ...
                              <div class="col-md-7">
                                <div class="col-md-3">
                                  ...
                                  <table class="table table-striped table-bordered dt-responsive wrap" id="tipe_bgn">
                                    ...
                                    <tbody id="tipeKolektif">
                                      <tr>
                                        <td>
                                          <input type="text" name="tipeA[1]" value="" style="width:100px;" id="posisi1" class="posisi1 form-control" />
                                        </td>
                                        <td><input type="text" name="luasA[1]" value="" style="width:100px;" id="luas1" class="unit1 form-control" />
                                        </td>
                                        <td><input type="text" name="tinggiA[1]" value="" style="width:100px;" id="tinggi1" class="tinggi1 form-control" />
                                        </td>
                                        <td><input type="text" name="lantaiA[1]" value="" style="width:100px;" id="lantai1" class="lantai1 form-control" />
                                        </td>
                                        <td><input type="text" name="jumlahA[1]" value="" style="width:100px;" id="jumlah1" class="jumlah1 form-control" />
                                        </td>
                          ...
                          <div id="fungsibg" class="form-group" style="display:none;">
                            ...
                            <div class="col-md-7">
                              <select name="id_fungsi_bg" id="selectFungsiBG" class="form-control">
                              </select>
                            </div>
                          </div>
                          ...
                          <div id="jns_bg_toggle" class="form-group" style="display:none;">
                            ...
                            <div class="col-md-7">
                              <select name="id_jns_bg" id="selectJenisBangunan" class="form-control">
                              </select>
                            </div>
                          </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                      ...
                      <div class="portlet-body">
                        <form action="<?= site_url('BangunanBertahap/SavePenilaian') ?>" role="form" method="post" id="formThree" enctype="multipart/form-data">
                          <div class="form-body">
...
<script defer src="<?php echo base_url() ?>assets/app/js/bangunan-bertahap.js"></script>