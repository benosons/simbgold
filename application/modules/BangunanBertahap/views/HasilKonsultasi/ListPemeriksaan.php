                ...
                <?php if ($konsultasi->num_rows() > 0) {
                    ...
                    foreach ($konsultasi->result() as $pbg) {
                        ...
                        <tr class="<?= $bgcolor ?>">
                            ...
                            <td align="center">
                                <?php if ($pbg->status == 6) : ?>
                                    <a href="<?= site_url("BangunanBertahap/FormPemeriksaan/{$this->secure->encrypt_url($pbg->id)}") ?>" class="btn btn-primary btn-sm" title="Input Hasil Konsultasi"><span class="fa fa-edit"></span></a>
                                    <div class="data-action"></div><br>
                                    <a href="<?php echo site_url('BangunanBertahap/Rollback/' . $pbg->id); ?>" class="btn btn-warning btn-sm" onclick="return confirm('Yakin Mengembalikan Permohonan ini ke Proses Penugasan TPA/TPT?')" title="Dikembalikan ke Proses Penjadwalan TPA/TPT"><span class="fa fa-arrow-left"></span>
                                    <?php else : ?>
                    ...
                    <div class="portlet-body">
                        <div class="tabbable-custom nav-justified">
                            <ul class="nav nav-tabs nav-justified">
                                ...
                                <li><a href="#tab_2_3" data-toggle="tab" class="lengkap1" style="display:none;">Data Arsitektur</a></li>
                                <li><a href="#tab_2_4" data-toggle="tab" class="lengkap2" style="display:none;">Data Struktur</a></li>
                                <li><a href="#tab_2_5" data-toggle="tab" class="lengkap3" style="display:none;">Data MEP</a></li>
                            </ul>
                ...
                success: function(response) {
                    if (response.res == true) {
                        ...
                        if (response.id_jenis_permohonan == 11) {
                            ...
                            $('.lengkap1').css('display', 'block');
                            $('.lengkap2').css('display', 'none');
                            $('.lengkap3').css('display', 'none');
                        } else {
                            $('.bangunan-kolektif').css('display', 'none');
                            $('.fungsi-bangunan').css('display', 'block');
                            $('.prasarana').css('display', 'none');
                            $('.lengkap1').css('display', 'block');
                            $('.lengkap2').css('display', 'block');
                            $('.lengkap3').css('display', 'block');
                        }
