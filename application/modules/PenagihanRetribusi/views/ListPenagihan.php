...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>List Data Penagihan Retribusi</div>
		<div class="tools">
				...
				<?php if($skrd->num_rows() > 0){
                	...
                	foreach ($skrd->result() as $skrd) { ?>
						...
						<tr class="<?=$clss?>">
							...
							<td><?php echo $skrd->nm_konsultasi;?></td>
							...
							<?php  if ($skrd->status == 11) { ?>
								<td align="center">
                                    ...
                                    <a href="<?php echo site_url('PenagihanRetribusi/RollSKRD/' . $skrd->id); ?>" class="btn btn-warning btn-sm" id="tombolver" data-toggle="modal" data-target="#modal-edit2" title="Dikembalikan ke Validasi Kepala Dinas Teknis"><span class="glyphicon glyphicon-edit"></span>
                                </td>
							<?php } else { ?>
								<td align="center">-</td>
							<?php } ?>
...
<div id="modalDetail" class="modal fade bs-modal-sm" data-width="60%" tabindex="-1" aria-hidden="true" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        </div>
        <div class="modal-body">
            <div id="content">
                <div class="portlet-title">
                    ...
                    <div class="fungsi-pertashop" style="display:none;">
                        <div class="row static-info">
                            <div class="col-md-4 name">Fungsi Bangunan Gedung</div>
                            <div class="col-md-8 value bgn-prasarana"></div>
                        </div>
                        <div class="row static-info">
                    ...
                    <div class="fungsi-prasarana" style="display:none;">
                        <div class="row static-info">
                            <div class="col-md-4 name">Fungsi Bangunan Gedung</div>
                            <div class="col-md-8 value bgn-prasarana"></div>
                        </div>
                    ...
                    <br>
                    <div class="row static-info">
                        <div class="col-md-4 name">Berita Acara</div>
                    ...
                    <div class="sistem-retribusi" style="display:none;"><br>
                        ...
                        <div class="row static-info">
                            <div class="col-md-4 name">Indeks Terintegrasi
                            </div>
                ...
                success: function(response) {
                    setTimeout(function() {
                        if (response.res == true) {
                            ...
                            $(".luas-tinggi-pertshop").html(`${response.luas_bgp} m<sup>2</sup>, dengan tinggi ${response.tinggi_bgp} meter`);                     
                            $(".bgn-prasarana").html(`${response.jns_prasarana}`);
                            ...
                            if (response.id_jenis_permohonan == 11 || response.id_jenis_permohonan == 29 || response.id_jenis_permohonan == 30 || response.id_jenis_permohonan == 31 || response.id_jenis_permohonan == 32) {
                                ...
                                $('.fungsi-prasarana').css('display', 'none');
                                $('.fungsi-pertashop').css('display', 'none');
                                ...
                                $('.fungsi-prasarana').css('display', 'block');
                                $('.fungsi-bangunan').css('display', 'none');
                                $('.bangunan-kolektif').css('display', 'none');
                                $('.fungsi-pertashop').css('display', 'none');
                            }else if(response.id_jenis_permohonan == 34){
                                $('.fungsi-pertashop').css('display', 'block');
                                $('.fungsi-prasarana').css('display', 'none');
                                $('.fungsi-bangunan').css('display', 'none');
                                $('.bangunan-kolektif').css('display', 'none');
                            }else if(response.id_jenis_permohonan == 14){
                                if(response.id_jenis_permohonan != 0){
                                    $('.fungsi-prasarana').css('display', 'block');
                                    $('.fungsi-bangunan').css('display', 'none');
                                    $('.bangunan-kolektif').css('display', 'none');
                                    $('.fungsi-pertashop').css('display', 'none');
                            ...
                            if (response.stats_retribusi == 2) {
                                ...
                                $(".luas-prasarana").html(`${response.luas_bgp} m<sup>2</sup>`);
