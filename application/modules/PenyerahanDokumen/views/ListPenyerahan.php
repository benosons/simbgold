<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>List Data Penyerahan Dokumen</div>
				...
				<?php if($Draft->num_rows() > 0) {
					...
					foreach ($Draft->result() as $Draft) { ?>
						...
						<tr class="<?=$clss?>">
							...
							<td align="center"><?php echo $Draft->no_izin_pbg;?></td>
							<td align="left"><?php echo $Draft->nm_pemilik;?></td>
							<!--td><?php echo $Draft->almt_bgn;?></td-->
							<td align="center">
								<a  href="#" onclick="GetCetakPBG(<?php echo $Draft->id ?>)" class="btn btn-info btn" title="Cetak Dokumen" id="tombolinver" ><span class="glyphicon glyphicon-print"> </span></a>
							</td>
							<td align="center">
								<?php if($Draft->status == 15){ ?>
									<a href="#" onClick="Xbit(<?php echo $Draft->id?>)" class="btn btn-danger btn-sm" ><span class="glyphicon glyphicon-edit">.</span>Penyerahan PBG</a>
								<?php } else { ?>
...
<div id="Penyerahan" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog">
	<div class="modal-dialog ">
		<form action="<?php echo site_url('PenyerahanDokumen/PenyerahanForm/'.$Draft->id); ?>" class="form-horizontal" role="form" method="post" id="hsnya" enctype="multipart/form-data">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" align="center"><b>Penyerahan Draf Persetujuan Bangunan Gedung</b></h4>
				</div>
...
<script>	
 ...
 function Xbit(id){
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('PenyerahanDokumen/Penyerahan/')?>",
                dataType : "JSON",
                data : {id:id},
