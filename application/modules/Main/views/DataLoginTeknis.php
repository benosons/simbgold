		  ...
		  <div class="row">
			<div class="col-md-6 hero-img"><img src="<?php echo base_url(); ?>assets/gambar/47860.jpg" class="img-fluid" alt=""></div>
				<div class="col-md-6 justify-content-center">
					...
					<ul>
						<?php  echo form_open('Front/LoginAksesTeknis', array('role'=>'form' , 'id'=>'frmLogin', 'class'=>'form-horizontal')); ?>
							<input type="hidden" class="form-control" value="<?= (isset($id) ? $id : ''); ?>" name="id" style="display: block;" autocomplete="off">
