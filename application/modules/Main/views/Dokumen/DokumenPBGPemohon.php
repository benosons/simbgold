...
if($bg['id_jenis_permohonan'] == '11'){
  ...
  $pdf->Cell(20, 5, ": ".number_format($bg['luas_bgp'],2,',','.'), 0, 0);
  $pdf->Cell(4,5,' m',0,0);
  ...
  $pdf->Cell(20, 5, ": ".number_format($bg['luas_bgn'],2,',','.'), 0, 0);
  $pdf->Cell(4,5,' m',0,0);
  $pdf->subWrite(5,'2','',6,4);
  $pdf->Cell(10,5,'',0,1);
}
...
if ($count_tanah>1) {
  ...
  if($bg['id'] =='23906' || $bg['id'] =='19279' || $bg['id'] =='7701' || $bg['id'] =='33918' || $bg['id'] =='13515' || $bg['id'] =='45907' || $bg['id'] =='15111' || $bg['id'] =='36804' || $bg['id'] =='33292' || $bg['id'] =='58377' || $bg['id'] =='45677' || $bg['id'] =='62481'){
    $pdf->Cell(1,5,'',0,0);
...
}else if($bg['id_kabkot_bgn'] =='6303' ||$bg['id_kabkot_bgn'] =='3674'){
  if($bg['id'] != '27116'){
    //$pdf->AddPage();
  }else{
...
}else if($bg['id_kabkot_bgn'] =='3273' || $bg['id_kabkot_bgn'] =='3204' || $bg['id_kabkot_bgn'] =='7271'){
  if($bg['id'] == '33292' || $bg['id'] == '85501' || $bg['id'] == '45677' || $bg['id'] == '76990' || $bg['id'] == '76997'){
