	...
	<div class="col-md-12">
		...
		<div class="portlet light ">
			<div class="portlet-title">
				<div class="caption caption-md"><i class="icon-bar-chart theme-font hide"></i><span class="caption-subject text-primary bold uppercase">Data Kadis Perizinan</span></div>
				<div class="actions">
						...
						<?php if ($user_result->num_rows() > 0) {
							...
							foreach ($user_result->result() as $key) {
								...
								<tr>
									...
									<td><?php echo $key->nama_lengkap; ?> </b></td>
									<td>
									...
									<td align="center">
										<!--<a data-href="<?php echo site_url('Pusat/hapus_kadis2/' . $key->id); ?>"
										...
										<a href="<?php echo site_url('Pusat/ResetPassPer/' . $key->id); ?>" class="btn btn-success btn-sm" title="Ubah Data Personil" data-toggle="modal" data-target="#static"><span class="glyphicon glyphicon-edit"></span></a>
									</td>
								</tr>
							<?php }
						} ?>
