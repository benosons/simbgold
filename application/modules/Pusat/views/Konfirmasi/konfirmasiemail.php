	...
	<div class="col-md-12">
		...
		<div class="portlet light ">
			<div class="portlet-title">
				<div class="caption caption-md"><i class="icon-bar-chart theme-font hide"></i><span class="caption-subject text-primary bold uppercase">Data Pendaftaran Akun Pemohon</span></div>
			</div>
				...
				<table class="table table-bordered btable" style="min-height:350px;">
					<thead>
						<tr>
							...
							<th style="width:6%">Tgl Pendaftaran</th>
						...
						<?php if ($user_result->num_rows() > 0) {
							...
							foreach ($user_result->result() as $key) {
								...
								<tr>
									...
									<td align="center" ><span class="<?php echo $class; ?>"><?php echo $key->post_date; ?></span></td>
									<td align="center">
										<a data-href="<?php echo site_url('Pusat/HpsTemuser/' . $key->id); ?>"
										...
										<a href="<?php echo site_url('Pusat/ResetPassPer/' . $key->id); ?>" class="btn btn-success btn-sm" title="Kirim Ulang Pendaftaran" data-toggle="modal" data-target="#static"><span class="glyphicon glyphicon-edit"></span></a>
									</td>
								</tr>
							<?php }
						} ?>
...
<div id="responKAM" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog" data-backdrop="static" data-width="700px" data-keyboard="false">
	<?php echo form_open_multipart('Pusat/simpan_perizinan', [
	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<span class="caption-subject text-primary bold uppercase " style="font-size:15px;">Form Data Kadis Perizinan</span>
		</div>
		<div class="modal-body">
			<div class="form-body">
				<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input has-success">
												<div class="input-group">
													...
													<label for="form_control_1">Kadis Perizinan Kabupaten / Kota<span class="required" aria-required="true"> * </span></label>
												</div>
											</div>
										</div>
...
<script>
	...
	function Rese2() {
		document.getElementById("tambah_perizinan").reset();
	};
