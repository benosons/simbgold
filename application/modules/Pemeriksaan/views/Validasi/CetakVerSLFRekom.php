...
//$pdf->Cell(0, 5, $result_list['nm_kabkot_bgn']." 2022", 0, 1, "R");
...
$pdf->Cell(2, 5, ":", 0, 0, "L");
$pdf->MultiCell(0, 5, $result_list['almt_bgn'].', Kel/Desa '.$result_list['nm_kel_bgn'].', Kec. '.$result_list['nm_kec_bgn'].', '.$result_list['nm_kabkot_bgn'].', Prov '.$result_list['nm_prov_bgn'], 0, "L", 0);
...
$pdf->Cell(0,5,'',0,1);
$pdf->Cell(45);
if($result_list['id_kabkot_bgn'] =='3573' || $result_list['id_kabkot_bgn'] =='3209'){
...
$pdf->Cell(0, 5, "DITETAPKAN DI ".$wilayah, 0, 1, "L");
$pdf->Cell(100, 5, "", 0, 0, "L");
$pdf->Cell(0, 5, "PADA TANGGAL ". tgl_eng_to_ind($bg['tgl_penerbitan_slf']), 0, 1, "L");
$pdf->Cell(100, 5, "", 0, 0, "L");
...
$pdf->Cell(5, 5, ":", 0, 0, "L");
$pdf->Cell(0, 5,$bg['luas_dasar']. " meter persegi", 0, 1, "L");
$pdf->Cell(15, 5, "", 0, 0, "L");
