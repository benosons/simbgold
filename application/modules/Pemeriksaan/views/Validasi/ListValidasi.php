...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-globe"></i>List Validasi Kepala Dinas Teknis</div>
                        ...
                        <tr class="<?= $clss ?>">
                            ...
                            <?php if ($Kadis->status == 10) { ?>
                                <td align="center">
                                    ...
                                    <div class="data-action"></div><br>
                                    <?php if($Kadis->imb == 1){ ?>
                                        <a href="<?php echo site_url('Pemeriksaan/RollbackKadis/' . $Kadis->id); ?>" class="btn btn-warning btn-sm" onclick="return confirm('Yakin Mengembalikan Permohonan ini ke Proses Perhitungan Retribusi?')"title="Dikembalikan ke Proses Perhitungan Retribusi"><span class="glyphicon glyphicon-edit"></span>
                                    <?php }else{ ?>
                                        <a href="<?php echo site_url('Pemeriksaan/RollbackKadis/' . $Kadis->id); ?>" class="btn btn-warning btn-sm" onclick="return confirm('Yakin Mengembalikan Permohonan ini ke Proses Perhitungan Retribusi?')"title="Dikembalikan ke Proses Perhitungan Retribusi"><span class="glyphicon glyphicon-edit"></span>
                                    <?php } ?>
                                </td>
...
<script>
    function GetCetakRekomtek(id) {
        var url = "<?php echo base_url() . index_page() ?>Pemeriksaan/CetakVerifikasi/" + id;
        swin = window.open(url, 'win', 'scrollbars,width=1000,height=600,top=80,left=140,status=yes,toolbar=no,menubar=yes,location=no');
        swin.focus();
    }
    function GetVerifikasi(id) {
        $("#MyModalBody").html('<iframe src="<?php echo base_url(); ?>Pemeriksaan/CetakVerifikasi/' + id + '" frameborder="no" width="860" height="540"></iframe>');
        $('[name="id"]').val(id);
    }
</script>
<script>
