<fieldset class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	<div class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
		<span><h2><b>Perhitungan Retribusi</b></h2></span>
	</div>
	<br>
	<div id="otomatis" style="display: block;">
		<table class="table table-bordered table-striped table-hover">
			<td width=60%>
				<table class="table table-bordered table-striped table-hover">
					<!-- Begin Bangunan Utama -->
					<tr class="info">
						<td>Nama Pemilik</td>
						<td>:</td>
						<td><?php echo 'Freddy' ;?></td>
					</tr>
					<tr class="info">
					...
					<tr class="info">
						...
						<td><select name=jenisretribusi>
							...
							<option value='Bangunan Gedung'>Bangunan Prasarana</option>
						</select></td>
					</tr>
					<tr class="info">
						<td>Fungsi</td><td>:</td>
					...
					<tr>
						<td colspan=3><br/><h4><b>Silahkan tentukan Indeks pada kolom isian di bawah ini :</b></h4></td>
					</tr>
					<?php
					...
					?>
					<tr class="info">
						<td><br/><h4>Waktu Penggunaan</h4></td><td><br/>:</td>
						<td><br/>
					...
					<tr>
						<td><br/>Luas Lantai Bangunan</td><td><br/>:</td>
						<td><br/><input type=number name=luaslantai id="luaslantai" value="0"></td>
					</tr>
					<!-- End Bangunan Utama -->
					<!--Begin Prasarana Pendukung -->
					<tr>
						<td colspan=3><br/><h4><b>Input Jika Memiliki Prasarana Pendukung</b></h4></td>
					</tr>
					<tr class="info">
						<td>Pagar</td><td>:</td>
						<td><input type=number name='volume' id='volume' value='0'> X
						<input type=number name='indekshargaprasaraa' id='indekshargaprasaraa' value='0'></td>
					</tr>
				</table>
			</td>
			<td width=40%>
				<h3><b>Hasil Perhitungan Retribusi</b></h3>
				<div class="hasil">
				...
				<br/>
				<h3><b>Harga Retribusi Bangunan Gedung</b></h3>
				<h3>
