											...
											<div class="input-group">
												...
												<?php if($id_retribusi != '' || $id_retribusi != null){?>
													<?php if ($dir_file_retribusi != ""){ ?>
														<a href="javascript:void(0);" onClick="javascript:popWin('<?php echo base_url('object-storage/file/imb/pengajuan_imb/'.$id_permohonan.'/retribusi/'.$dir_file_edit_perhitungan);?>')" class="btn default btn-md blue-stripe" >Berkas Penghitungan Retribusi</a>
													<?}else{?>
