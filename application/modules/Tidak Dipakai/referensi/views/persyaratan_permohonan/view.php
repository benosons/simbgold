<form action="<?php echo site_url('pupr/pengaturan_sk_tabg_save'); ?>" class="form-horizontal" role="form" method="post" id="form_edit_persyaratan_permohonan">
    <div class="modal-content">
            ...
            <div class="row">
                        ...
                        <div class="portlet-body">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div>
                                            <input type="hidden" class="form-control" id="id" value="<?php echo $row->id_jenis_permohonan ?>" name="id" placeholder="id" autocomplete="off">
                ...
                <div class="col-md-12 ">
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i>List Peryaratan
                            </div>
                            <div class="tools">
                                <a href="javascript:;" class="collapse">
                                </a>
                        ...
                        <div class="portlet-body">
                            ...
                            $var = '';
                            $element = 'checkbox';
                            if ($query_syarat_selected_view->num_rows() > 0) :
                                $var = '<div class="md-checkbox-list">';
                                foreach ($query_syarat_selected_view->result() as $row) :
                                    if ($element == 'checkbox') {
                                        $setVal     = '';
                                        foreach ($query_syarat_selected->result() as $key) :
                                            // $id_dokumen_permohonan == $key->id_syarat;
                                            if ($row->id_syarat == $key->id_syarat) {
        ...
        <div class="modal-footer">
            <button type="button" data-dismiss="modal" class="btn default">Keluar</button>
        </div>
    </div>
</form>
...
<script type="text/javascript">
    ...
    jQuery.post(base_url + 'referensi/listPersyaratanAdmShow', {
        value: id,
        disable: 'N'
    }, function(data) {
        jQuery('#show_listmenueditAdm').append(data);
    ...
    jQuery.post(base_url + 'referensi/listPersyaratanTeknisShow', {
        value: id,
        disable: 'N'
    }, function(data) {
