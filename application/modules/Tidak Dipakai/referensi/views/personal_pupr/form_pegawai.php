	...
	<div class="col-md-12">
		<div class="portlet box blue" id="form_wizard_1">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i> Form Data Pegawai
				</div>
				...
				<div class="form-wizard">
					<ul class="nav nav-pills nav-justified steps">
						<?php
							...
							$id = (isset($asn->id) ? $asn->id : '');
							if($id != ''){$statusTab1='done';}else{$statusTab1='active';$Tab1='active';}
							if($statusTab1 == 'done'){$statusTab2='active'; $Tab2='active';}
							
							if($id != '' && count($DataTanah) > 0){$statusTab2 = 'done';}
			...
			<div class="row">
				<div class="col-md-offset col-md-9">
					<button type="button" class="btn btn-primary" onClick="window.location.href = '<?php echo base_url();?>referensi/personil_asn';return false;" ><i class="fa fa-arrow-left"></i> Kembali </button>
				</div>
			</div>
		</div>
	</div>
