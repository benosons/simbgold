...
<div class="row">
	...
	<div class="portlet box blue-hoki">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-globe"></i>List Data Persyaratan IMB dan SLF
			</div>
		</div>
			...
			<table id="example1" class="table table-bordered table-striped table-hover">
	            ...
	            ?>
	                <tr>
	                  ...
	                  <td align="center"><a href="<?php echo site_url('referensi/form_edit_provinsi/'.$prov->id_provinsi);?>" class="btn btn-warning btn-sm" title="Ubah Data" data-toggle="modal" data-target="#modal-edit"><span class="glyphicon glyphicon-pencil"></span></a> <a href="<?php echo site_url('referensi/removeDataProvinsi/'.$prov->id_provinsi);?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ini?')" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></a></td>
	                </tr>
	                <?php			
	                		}
	                	}
...
<div id="responsive" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog">
	<div class="modal-dialog modal-lg">
		<form action="<?php echo site_url('referensi/saveDataProvinsi'); ?>" class="form-horizontal" role="form" method="post" id="from_provinsi">
						...
						<div class="col-md-12 ">										
							<div class="form-body">
								<div class="form-group">
									...
									<div class="col-md-9">													
										<input type="text" class="form-control" name="nama_provinsi" placeholder="Nama Provinsi" autocomplete="off">
									</div>
								</div>
							</div>	
						</div>	
