									...
									<div class="portlet-body form">
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<? if(isset($DataPermohonan->nib) && $DataPermohonan->nib != ""){?>
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-7">
														<select class="form-control select2me" name="id_jenis_bg" id="id_jenis_bg" onchange="getjenisPermohonan(this.value)">
															<option value="">--Pilih--</option>
												...
												<div id="Kolektif" style="display: none;">
													<div class="form-group">
														<label class="control-label col-md-3">Tipe Permohonan Kolektif<span class="required">
															* </span></label>
															<div class="col-md-7">
																<select class="form-control select2me" name="id_kolektif" id="id_kolektif" onchange="tpk(this.value)">
																	<option value="">--Pilih--</option>
