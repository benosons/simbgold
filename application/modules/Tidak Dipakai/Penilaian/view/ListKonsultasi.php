				...
				?>
	                <tr class="<?=$clss?>">
					  ...
					  <?}else{?>
								...
								<td align="center"><a href="#" onClick="href='<?php echo site_url('detail/detail_imb/'.$Konsultasi->id);?>'" class="btn btn-info btn-sm" title="Lihat Data" id="tombolinver" data-toggle="modal" data-target="#modal-edit"><span class="glyphicon glyphicon-user"></span></a></td>
								<?}else{?>
								<td align="center"><a href="#" onClick="href='<?php echo site_url('DinasTeknis/FormVerifikasi/'.$Konsultasi->id);?>'" class="btn btn-success btn-sm" title="Verifikasi Data" id="tombolver" data-toggle="modal" data-target="#modal-edit"><span class="glyphicon glyphicon-edit"></span></a></td>
								<?}?>
					  <?}?>
