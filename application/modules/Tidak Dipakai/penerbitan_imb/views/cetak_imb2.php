...
if ($count_tanah>1) {
  ...
  if ($row['hat'] != 0) {
    $pdf->Cell(81,5,'',0,0);
    $pdf->Cell(40,5,(isset($list_jenis_bg[$hat]) ? $list_jenis_bg[$hat] : '[ HAK ATAS TANAH KOSONG ]'),0,0);
	$pdf->Cell(15,5,(isset($row['luas_tanah']) ? $row['luas_tanah'] : '[ LUAS TANAH KOSONG ]'),0,0);
	$pdf->Cell(4,5,' m',0,0);
	$pdf->subWrite(5,'2','',6,4);
  }
  $pdf->Cell(81,5,'',0,0);
