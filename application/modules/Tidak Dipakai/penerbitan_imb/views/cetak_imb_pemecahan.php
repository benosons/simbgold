...
$pdf->Image(BASE_FILE_PATH.'/foto/profil/'.$logo,95,15,22);
...
$pdf->SetFont('ARIAL','',12);
$pdf->Cell(0,20,$pejabat.' '.(isset($kabkota) ? $kabkota : '[ NAMA PROVINSI KOSONG ]'),0,2,'C');
...
$pdf->Cell(2,5,':',0,0);
$pdf->Cell(49,5,$result_list['no_imb'],0,0,'L');
...
$pdf->Cell(2,5,':',0,0);
$pdf->Cell(10,5,(isset($result_list['nama_bangunan']) ? ucwords(strtolower($result_list['nama_bangunan'])) : '[ NAMA BANGUNAN KOSONG ]'),0,1);
...
if ($count_tanah>1) {
  ...
  if ($row['hat'] != 0) {
    $pdf->Cell(100,5,'',0,0);
    // $pdf->Cell(15,5,(isset($row['hat']) ? $row['hat'] : '[ HAK ATAS TANAH KOSONG ]'),0,1);
...
$pdf->Cell(2,5,':',0,0);
$pdf->Cell(10,5,(isset($result_list['lokasi_tanah']) ? ucwords(strtolower($result_list['lokasi_tanah'])) : '[ LOKASI TANAH KOSONG ]'),0,1);


$pdf->Cell(33,5,'',0,0);
$pdf->Cell(42,5,'',0,0,'L');
$pdf->Cell(2,5,'',0,0);
$pdf->Cell(10,5,(isset($row['nama_kecamatan']) ? 'Kec. '.ucwords(strtolower($row['nama_kecamatan'])).', '.ucwords(strtolower($row['nama_kabkota'])) : '[ NAMA KECAMATAN/KABKOT KOSONG ]'),0,1);

$pdf->Cell(33,5,'',0,0);
$pdf->Cell(42,5,'',0,0,'L');
$pdf->Cell(2,5,'',0,0);
$pdf->Cell(10,5,(isset($row['nama_provinsi']) ? 'Prov. '.ucwords(strtolower($row['nama_provinsi'])) : '[ NAMA PROVINSI KOSONG ]'),0,1);
...
foreach ($result_uu as $key => $value) {
  ...
  $pdf->Cell(33,5,'',0,0);
	...
	$pdf->MultiCell(0,5,$value['keterangan'],0,'J',0,1);
	$pdf->Cell(33,5,'',0,0);
	}
...
/* $pdf->Cell(38,5,'',0,0);
$pdf->Cell(42,5,'Atas nama pemilik',0,0,'L');
$pdf->Cell(2,5,':',0,0);
$pdf->Cell(10,5,'......',0,1);
$pdf->Cell(38,5,'',0,0);
$pdf->Cell(42,5,'bangunan gedung',0,1,'L'); */
...
// $pdf->Cell(0,0,'---------------------------------------------------------',0,1);
$pdf->Cell(90);
$pdf->Cell(0,5,'ATAS NAMA '.$pejabat,0,1);
$pdf->Cell(90);
$pdf->Cell(0,5,$kabkota,0,1);
$pdf->Cell(90); $pdf->Cell(0,5,'KEPALA DINAS',0,1);
$pdf->Cell(0,0,'',0,1);
