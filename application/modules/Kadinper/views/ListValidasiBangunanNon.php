...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>List Validasi Sertifikat Laik Fungsi Bangunan Eksisting Oleh Kepala Dinas Perizinan</div>
...
{
	$("#MyModalBody").html('<iframe src="<?php echo base_url();?>Dokumen/CetakDokumenLaikFungsi/'+id+'" frameborder="no" width="860" height="540"></iframe>');
	$('[name="id"]').val(id) ; 
}
</script>
<script>
