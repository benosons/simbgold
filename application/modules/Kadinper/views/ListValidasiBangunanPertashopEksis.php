...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>List Validasi Persetujuan Bangunan PertaShop Eksisting Oleh Kepala Dinas Perizinan</div>
                    ...
                    <tr class="<?=$clss?>">
                        ...
                        <?php if ($Kadis->status == 13) { ?>
							<td align="center">
                                ...
                                <a href="<?php echo site_url('Kadinper/RollbackKadisPrasarana/' . $Kadis->id); ?>" class="btn btn-warning btn-sm" onclick="return confirm('Yakin Mengembalikan Permohonan ini ke Proses Validasi Pembayaran Retribusi?')"title="Dikembalikan ke Proses Validasi Pembayaran Retribusi"><span class="glyphicon glyphicon-edit"></span>
                            </td>
                        <?php } else { ?>
							<td align="center">
                                <a  href="#" onclick="GetCetakDokumen(<?php echo $Kadis->id ?>)" class="btn btn-info btn" title="Cetak IMB" id="tombolinver" ><span class="glyphicon glyphicon-print"> Terverifikasi (Lihat PBG)</span></a>
							</td>
                        <?php } ?>
					</tr>
                    <?php }
...
<div class="modal fade" id="dialog-popup" data-width="53%" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form action="<?php echo site_url('Kadinper/ValidasiFormPertashopEksis'); ?>" class="form-horizontal" role="form" method="post">
