...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>List Validasi Persetujuan Bangunan Gedung Eksisting Oleh Kepala Dinas Perizinan</div>
...
<div class="modal fade" id="dialog-popup" data-width="53%" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form action="<?php echo site_url('Kadinper/ValidasiFormPrasarana'); ?>" class="form-horizontal" role="form" method="post">
