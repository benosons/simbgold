...
if($bt['status'] =='10'){
	...
	$tgl_tek 			= tgl_eng_to_ind($tgl_skrg)."( **:sesuai tanggal validasi)";
...
$myarray 		= array($bt['id_jns_bg'][2], $bt['id_jns_bg'][6]);
$arraydata 		= implode('dan ',$myarray);
$Data1			= $bt['id_jns_bg'][2];
$Data2			= $bt['id_jns_bg'][6];
if($Data1 =='1'){
	$Campuran='Hunian';
}else if($Data1 =='2'){
	$Campuran='Keagamaan';
...
if($bt['id_izin'] == '1'){// Bangunan Tunggal Baru 
	if($bt['id_fungsi_bg'] == '6'){// Fungsi Campuran
		...
		$pdf->Cell(2, 5, ":", 0, 0, "L");
		$pdf->Cell(0, 5,  $Campuran." dan ". $Campuran1, 0, 1, "L"); 
