...
if($bg['tgl_validasi'] !='' || $bg['tgl_validasi'] != null){
  $tgl_validasi = tgl_eng_to_ind($bg['tgl_validasi']);
}else{
...
$pdf->Cell(0, 5, ": ".$bg['no_izin_pbg']." Tanggal ".$tgl_validasi, 0, 1, "L");
$pdf->Cell(42, 5, "", 0, 0, "L");
...
} else if($bg['id_jenis_permohonan'] == '21'){
  $pdf->Cell(42, 5, "", 0, 0, "L");
...
if ($count_tanah>1) {
  ...
  if($bg['id'] =='23906' || $bg['id'] =='19279' || $bg['id'] =='7701' || $bg['id'] =='33918' || $bg['id'] =='13515' || $bg['id'] =='45907' || $bg['id'] =='15111' || $bg['id'] =='36804' || $bg['id'] =='33292' || $bg['id'] =='58377' || $bg['id'] =='45677' || $bg['id'] =='62481' || $bg['id'] =='97223' || $bg['id'] =='2111'
  || $bg['id'] =='62869' || $bg['id'] =='88685' || $bg['id'] =='87380' || $bg['id'] =='83022' || $bg['id'] =='42558' || $bg['id'] =='120663' || $bg['id'] =='104677' || $bg['id'] =='53622' || $bg['id'] =='103393' || $bg['id'] =='91123' || $bg['id'] =='91115' || $bg['id'] =='91106' || $bg['id'] =='106449' || $bg['id'] =='51914'
  || $bg['id'] =='50743' || $bg['id'] =='136783' || $bg['id'] =='158829' || $bg['id'] =='138929' || $bg['id'] =='88611' || $bg['id'] =='99112' || $bg['id'] =='178582'){  
    $pdf->Cell(1,5,'',0,0);
...
if($bg['id_kabkot_bgn'] =='1371' ){
  if($bg['id'] == '23906' ||$bg['id'] == '13515' ||$bg['id'] == '36804' ||$bg['id'] == '97223' ||$bg['id'] == '62869'){ 
    $pdf->AddPage();
  }else{
    $pdf->Cell(0, 2, "", 0, 1, "L");
  }
}else if($bg['id_kabkot_bgn'] =='6303' ||$bg['id_kabkot_bgn'] =='3674' ||$bg['id_kabkot_bgn'] =='3577' ||$bg['id_kabkot_bgn'] =='3515'){
  if($bg['id'] != '27116'){ 
    //$pdf->AddPage();
  }else{
...
}else if($bg['id_kabkot_bgn'] =='3273' || $bg['id_kabkot_bgn'] =='3204' || $bg['id_kabkot_bgn'] =='7271' || $bg['id_kabkot_bgn'] =='3577' || $bg['id_kabkot_bgn'] =='3317' || $bg['id_kabkot_bgn'] =='5105' || $bg['id_kabkot_bgn'] =='3203'){
  if($bg['id'] == '33292' || $bg['id'] == '85501' || $bg['id'] == '45677' || $bg['id'] == '76990' || $bg['id'] == '76997' || $bg['id'] == '2111' || $bg['id'] == '103393' || $bg['id'] == '106449' || $bg['id'] == '51914' || $bg['id'] == '50743' || $bg['id'] == '158829' || $bg['id'] == '88611' || $bg['id'] == '99112' || $bg['id'] == '178582'){  
