...
if($bg['id_izin'] =='5'){
    $peruntukan = "Bangunan Prasarana Baru";
}else{
...
if ($bg['id_izin'] == '5') {
    ...
    $pdf->Cell(42, 5, "", 0, 0, "L");
    $pdf->Cell(50, 5, "Jenis Bangunan", 0, 0, "L");
    $pdf->Cell(2, 5, ":", 0, 0, "L");
...
$pdf->MultiCell(0, 5, "Besaran retribusi telah dibayar oleh pemohon sebagaimana Dimaksud dalam Lampiran d Keputusan ini sebesar:", 0, "L", 0);
$pdf->Cell(55, 5, "", 0, 0, "L");
