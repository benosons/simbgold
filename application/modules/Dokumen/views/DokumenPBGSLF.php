...
$k=1;
if ($count_tanah>1) {
  if($bg['id'] =='80036' || $bg['id'] =='79663' || $bg['id'] =='42558' || $bg['id'] =='94584' || $bg['id'] =='160572'){  
    $pdf->Cell(1,5,'',0,0); 
...
if($bg['id_kabkot_bgn'] =='1371' || $bg['id_kabkot_bgn'] =='6303' || $bg['id_kabkot_bgn'] =='5171' || $bg['id_kabkot_bgn'] =='3404'){ 
  $pdf->Cell(0, 2, "", 0, 1, "L");
}else{
  $pdf->AddPage();
}
