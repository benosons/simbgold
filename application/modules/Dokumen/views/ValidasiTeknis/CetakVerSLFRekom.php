...
$pdf->Cell(100, 5,"Nomor : ".$result_list2['no_sk_tk'], 0, 0, "L");
$pdf->Cell(0, 5, $result_list2['nm_kabkot_bgn'] . ", " . tgl_eng_to_ind($result_list2['date_sk_tk']), 0, 1, "R");
...
if($result_list2['id_prasarana_bg'] == null || $result_list2['id_prasarana_bg'] == '0'){
  ...
  $pdf->Cell(2, 5, ":", 0, 0, "L");
  $pdf->Cell(0, 5, $result_list2['luas_bgn'], 0, 1, "L");
  $pdf->Cell(20, 5, "", 0, 0, "L");
  ...
  $pdf->Cell(2, 5, ":", 0, 0, "L");
  $pdf->Cell(0, 5, $result_list2['luas_bgp'] .' Meter Persegi', 0, 1, "L");
  $pdf->Cell(20, 5, "", 0, 0, "L");
...
if ($count_tanah>1) {
  ...
  foreach ($result_tanah as $key => $row) {
		...
		if ($row['luas_tanah'] != 0 || $row['luas_tanah'] == null){
			$pdf->Cell(4,5,' meter persegi',0,0);
			//$pdf->subWrite(5,'2','',6,4);
			$pdf->Cell(10,5,'',0,1);
		}
		$pdf->Cell(20,5,'',0,0);
...
$pdf->Cell(0,5,'',0,1);
$pdf->Cell(45);
$pdf->Cell(0,0,$pdf->image(BASE_FILE_PATH2.'QR_Code/'.$result_list2['no_konsultasi'].'.png', $pdf->GetX(), $pdf->GetY(), 30,30),0,1);
...
$pdf->image(BASE_FILE_PATH2.'QR_Code/'.$result_list2['no_slf'].'.png', 60, 180, 30, 30);
$pdf->Cell(100, 5, "", 0, 0, "L");
$pdf->Cell(0, 5, "DITETAPKAN DI ".$wilayah, 0, 1, "L");
$pdf->Cell(100, 5, "", 0, 0, "L");
...
/*if($result_list2['stat_pejabat'] =='1'){
  $pdf->Cell(100, 5, "", 0, 0, "L");
  $pdf->MultiCell(0, 5, "PLT KEPALA " .ucwords(strtoupper($result_list2['nm_dinas'])), 0, "L", 0);
} else if($result_list2['stat_pejabat'] =='2'){
  $pdf->Cell(100, 5, "", 0, 0, "L");
  $pdf->MultiCell(0, 5, "PJS KEPALA " .ucwords(strtoupper($result_list2['nm_dinas'])), 0, "L", 0);
} else if($result_list2['stat_pejabat'] =='3'){
  $pdf->Cell(100, 5, "", 0, 0, "L");
  $pdf->MultiCell(0, 5, "KEPALA " .ucwords(strtoupper($result_list2['nm_dinas'])), 0, "L", 0);
}else{
  $pdf->Cell(100, 5, "", 0, 0, "L");
  $pdf->MultiCell(0, 5, "KEPALA " .ucwords(strtoupper($result_list2['nm_dinas'])), 0, "L", 0);
}*/
...
$pdf->Cell(0, 5, "", 0, 1, "L");
$pdf->Cell(100, 5, "", 0, 0, "L");
$pdf->Cell(0, 5, ($result_list2['nm_kadis_teknis']), 0, 1, "L");
$pdf->Cell(100, 5, "", 0, 0, "L");
...
$pdf->Cell(5, 5, ":", 0, 0, "L");
$pdf->MultiCell(0, 5,$result_list2['almt_bgn'].", Kel/Desa. ".$result_list2['nama_kelurahan'].", Kec ".$result_list2['nama_kecamatan'].", ".ucwords(strtolower($result_list2['nama_kabkota'])).", Prov ".$result_list2['nama_provinsi'], 0, "L", 0);
$pdf->Cell(15, 5, "", 0, 0, "L");
