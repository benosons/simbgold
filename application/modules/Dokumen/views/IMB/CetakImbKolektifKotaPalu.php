...
if ($count_tanah>1) {
  ...
  $pdf->MultiCell(75,5,(isset($row['atas_nama_dok']) ? $row['atas_nama_dok'] : '[ PEMILIK TANAH KOSONG ]'),0,1);
...
if ($result_list['id_permohonan'] == 31036 || $result_list['id_permohonan'] == 59916 ){
	$pdf->AddPage();
}else{
...
/*if ($result_list['id_permohonan'] != '31036' || $result_list['id_permohonan'] != '44106'){
	$pdf->AddPage();
}else{
