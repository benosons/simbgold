...
$pdf->Cell(33,5,'',0,0);
$pdf->Cell(42,5,'Nomor SK IMB Tunggal',0,0,'L');
$pdf->Cell(2,5,':',0,0);
$pdf->Cell(49,5,$result_list['no_imb'],0,1,'L');

$pdf->Cell(33,5,'',0,0);
$pdf->Cell(42,5,'Nomor SK IMB Induk',0,0,'L');
$pdf->Cell(2,5,':',0,0);
$pdf->Cell(49,5,$Kolektif['sk_imb_kolektif'],0,1,'L');
...
$pdf->MultiCell(0,5,(isset($alamat_pemilik) ? $alamat_pemilik : '[ NAMA PEMILIK  KOSONG ]').", ".(isset($result_list['nama_kecamatan']) ? 'Kec. '.$result_list['nama_kecamatan'].', '.ucwords(strtolower($result_list['nama_kabkota'])) : '[ NAMA KECAMATAN/KABKOT KOSONG ]').", ".(isset($result_list['nama_provinsi']) ? 'Prov. '.ucwords(strtolower($result_list['nama_provinsi'])) : '[ NAMA PROVINSI KOSONG ]'),0,'J',0);
...
$pdf->Cell(2,5,':',0,0);
$pdf->MultiCell(0,5,(isset($result_list['jns_bangunan']) ? ucwords(strtolower($result_list['jns_bangunan'])) : '[ JENIS BANGUNAN KOSONG ]'),0,'J',0);
...
$pdf->Cell(2,5,':',0,0);
$pdf->MultiCell(0,5,(isset($result_list['nama_bangunan']) ? ucwords(strtoupper($result_list['nama_bangunan'])) : '[ NAMA BANGUNAN KOSONG ]'),0,'J',0);


$luas_bg = $result_list['luas_bg'];
...
$pdf->Cell(14,5,number_format($luas_bg,2,',','.'),0,0);
...
if ($count_tanah>1) {
  ...
  $pdf->Cell(100,5,'',0,0);
  $pdf->Cell(14,5,number_format($luas_tanah,2,',','.'),0,0);
...
$pdf->SetFont('ARIAL','',10);
$pdf->Cell(4,5,'1.',0,0);
$pdf->MultiCell(0,5,'Permohonan Pemecahan IMB Induk Nomor '.$Kolektif['sk_imb_kolektif'],0,'J',0);
...
$pdf->Cell(75,5,'( Nol rupiah )',0,1,'L');
