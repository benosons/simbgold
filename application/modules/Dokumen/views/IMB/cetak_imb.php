...
$i=1;
$i=1;
if($result_list['id_kabkot_bg'] !='3401'){
	...
	if($result_list['tgl_imb'] >"2021-08-02"){
		foreach ($result_uu_ck as $key => $value) {
		  $pdf->Cell(5,5,$i++.'.',0,0);
		  $pdf->MultiCell(0,5,$value['uu'],0,'J',0,1);
		  $pdf->Cell(33,5,'',0,0);
		}
...
if($result_list['ttd_pejabat_sk'] =='Drs. SEPTEDY, M.Si'){
	...
	if($result_list['tgl_imb'] < '2021-12-22' ){
		$Kasid ='Plt. KEPALA';
		//$Kasid='KEPALA';
	}else if($result_list['tgl_imb'] >='2021-01-15' ){
		//$Kasid ='Plt. KEPALA';
		$Kasid='KEPALA';
	}else{
		$Kasid='KEPALA';
