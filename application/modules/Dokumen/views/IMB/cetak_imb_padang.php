...
$pdf->MultiCell(0,5,(isset($alamat_pemilik) ? $alamat_pemilik : '[ Alamat Pemilik Kosong ]').", ".(isset($result_list['nama_kecamatan']) ? 'Kec. '.$result_list['nama_kecamatan'].', '.ucwords(strtolower($result_list['nama_kabkota'])) : '[ NAMA KECAMATAN/KABKOT KOSONG ]').", ".(isset($result_list['nama_provinsi']) ? 'Prov. '.$result_list['nama_provinsi'] : '[ NAMA PROVINSI KOSONG ]'),0,'J',0);
