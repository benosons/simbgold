...
$wilayah = $result_list['nama_kabkota'];
...
if($result_list['luas_bgn'] <='72'){
    if($result_list['jml_lantai'] =='1'){
...
$pdf->Cell(2, 5, ":", 0, 0, "L");
$pdf->Cell(100, 5, $result_list['no_sk_tk'], 0, 0, "L");
$pdf->Cell(0, 5, ucwords(strtolower($result_list['nama_kabkota'])). ", " . $tgl_validasi, 0, 1, "R");
...
$tgl_pernyataan  = $result_list['tgl_pernyataan'];
...
if($result_list['id_prasarana_bg'] == null || $result_list['id_prasarana_bg'] == '0'){
  ...
  $pdf->Cell(2, 5, ":", 0, 0, "L");
  $pdf->MultiCell(0, 5, $result_list['nm_bgn'], 0, "L", 0);
  $pdf->Cell(20, 5, "", 0, 0, "L");
  $pdf->Cell(50, 5, "Luas Bangunan Gedung", 0, 0, "L");
  $pdf->Cell(2, 5, ":", 0, 0, "L");
  $pdf->Cell(0, 5, $result_list['luas_bgn'], 0, 1, "L");
  $pdf->Cell(20, 5, "", 0, 0, "L");
  $pdf->Cell(50, 5, "Jumlah Lantai/tinggi Bangunan", 0, 0, "L");
  $pdf->Cell(2, 5, ":", 0, 0, "L");
  ...
  $pdf->Cell(50, 5, "Jenis Bangunan Gedung ", 0, 0, "L");
  $pdf->Cell(2, 5, ":", 0, 0, "L");
  $pdf->Cell(0, 5, $result_list['jns_prasarana'], 0, 1, "L"); // Perlu di cek untuk Jenis Bangunan
  ...
  $pdf->Cell(2, 5, ":", 0, 0, "L");
  $pdf->Cell(0, 5, $result_list['luas_bgp'] .' Meter Persegi', 0, 1, "L");
  $pdf->Cell(20, 5, "", 0, 0, "L");
  $pdf->Cell(50, 5, "Tinggi Bangunan Prasarana", 0, 0, "L");
  $pdf->Cell(2, 5, ":", 0, 0, "L");
...
if ($count_tanah>1) {
  ...
  foreach ($result_tanah as $key => $row) {
    ...
    $pdf->Cell(47,5,$j++.'. Atas Nama',0,0);
      $pdf->Cell(2,5,':',0,0);
      $pdf->MultiCell(110,5,(isset($row['atas_nama_dok']) ? ucwords(strtolower($row['atas_nama_dok'])) : '[ PEMILIK TANAH KOSONG ]'),0,"L",0);
      if ($row['hat'] != 0) {
        $pdf->Cell(27,5,'',0,0);
...
$pdf->Cell(0,5,'',0,1);
$pdf->Cell(25);
$pdf->Cell(0,0,$pdf->image(BASE_FILE_PATH2.'QR_Code/'.$result_list['no_konsultasi'].'.png', $pdf->GetX(), $pdf->GetY(), 40,40),0,1);
...
$pdf->MultiCell(0, 5,$result_list['almt_bgn'].', Kel/Desa '.$result_list['nama_kelurahan'].', Kec. '.$result_list['nama_kecamatan'].', '.ucwords(strtolower($result_list['nama_kabkota'])).', Prov '.$result_list['nama_provinsi'], 0, "C", 0);
...
$pdf->image(BASE_FILE_PATH2.'QR_Code/'.$result_list['no_slf'].'.png', 50, 180, 30, 30);
...
$pdf->Cell(100, 5, "", 0, 0, "L");
$pdf->Cell(0, 5, "NIP. ".$result_list['nip_kadis_teknis'], 0, 1, "L");
...
$pdf->MultiCell(50, 10, "Lingkup Sertifikat Layak Fungsi", 1, "C", 0);
$pdf->Cell(15, 5, "", 0, 0, "L");
$pdf->Cell(20, 10, "", 1, 0, "C");
$pdf->Cell(40, 10, "", 1, 0, "C");
$pdf->Cell(40, 10, "", 1, 0, "C");
$pdf->MultiCell(50, 10, "", 1, "C", 0);
$pdf->Cell(15, 5, "", 0, 0, "L");
$pdf->Cell(20, 10, "", 1, 0, "C");
$pdf->Cell(40, 10, "", 1, 0, "C");
$pdf->Cell(40, 10, "", 1, 0, "C");
