...
<div class="row">
    <div class="col-md-12">
        <div class="portlet-title">
            ...
            <div class="row static-info">
                ...
                <div class="col-md-8 value alamat-bangunan">
            ...
            <div class="row static-info">
                ...
                <div class="col-md-8 value fungsi-bangunan-gedung">
            ...
            <div class="tabbable-custom nav-justified">
                ...
                <div class="tab-content">
                    ...
                    <?php $this->load->view('penjadwalan_konsultasi') ?>
    ...
    <script type="text/javascript">
        ...
        function Xwin(id) {
            $.ajax({
                type: "GET",
                url: "http://localhost:80/simbg/penjadwalan/hasil_konsultasinya/",
                dataType: "JSON",
                data: {
                    id: id
                },
                success: function(data) {
                    $.each(data, function() {
                        ...
                        $('[name="x_konsultasike_p"]').val(data.konsultasi_ke);
                    });
                }
            });
            return false;
        ...
        $(function() {
            ...
            $("#hsnya").validate({
                ...
                messages: {
                    x_status_p: "Tentukan Hasil Konsultasi",
                    //x_cat_p: "Masukan Catatan",
                    d_file_x: "Unggah Hasil Konsultasi",
                },
        ...
        $(function() {
            ...
            $("#jsnya").validate({
                ...
                // Specify the validation error messages
                messages: {
                    konsultasi_ke: "Pilih Konsultasi",
                    tanggal_konsultasi: "Tentukan Tanggal Konsultasi",
                    jam_konsultasi: "Tentukan Jam Konsultasi",
