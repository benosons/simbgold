...
function set_pemanfaatan(v){
	if(v == '1'){
		document.getElementById('pertanyaanNIB').style.display="block";
		...
		document.getElementById('pertanyaanNIB').style.display="none";
...
function popupNIB() {
	var nib = document.getElementById("nibnya").value;
	
	if (nib == ""){
		alert("Harap masukan NIB Anda !");
	...
	$.ajax({
        ...
        success: function(response) {
			if(response == ''){
				alert("NIB tidak terdaftar pada sistem OSS, jika belum memiliki NIB silahkan lakukan pendaftaran pada sistem OSS");
				//document.getElementById('nibnya').focus();
									...
									<div class="portlet-body form">
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="form-group" id="pertanyaanNIB">
												...
												<div id="Nib" style="display: none;">
													<div class="form-group">
														...
														<div class="col-md-7">
																<input type="number" class="form-control" name="nib" id="nibnya" placeholder="8120001340969" onchange="popupNIB()" />
												...
												<div id="nib_list" style="display: none;">
													<div class="form-group">
													<label class="control-label col-md-3">Pilih Bangunan<span class="required">* </span></label>
													<div class="col-md-8">
												...
												<div class="form-group">
													...
													* </span></label>
													<div class="col-md-7">
														<select class="select form-control" name="id_jenis_usaha">
															<option value="">--Pilih--</option>
												...
												<div id="Kolektif" style="display: none;">
													<div class="form-group">
														<label class="control-label col-md-3">Tipe Permohonan Kolektif<span class="required">
															* </span></label>
															<div class="col-md-7">
																<select class="form-control select" name="id_kolektif" onchange="tpk(this.value)">
																	<option value="">--Pilih--</option>
												...
												<div id="NonPrasarana" style="display: none;">
													...
													<div class="form-group" id="campurincek" style="display: none;">
														...
														<label>
															<input type="checkbox" class="form-control" name="dcampur[]" value="Hunian"> Hunian </label>
														<label>
															<input type="checkbox" class="form-control" name="dcampur[]" value="Keagamaan"> Keagamaan </label>
														<label>
															<input type="checkbox" class="form-control" name="dcampur[]" value="Usaha"> Usaha </label>
														<label>
															<input type="checkbox" class="form-control" name="dcampur[]" value="Sosial & Budaya"> Sosial & Budaya </label>
														<label>
															<input type="checkbox" class="form-control" name="dcampur[]" value="Khusus"> Khusus </label>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Luas Bangunan <i>(m<sup>2</sup>)</i><span class="required">* </span></label>
												...
												<div id="dokumen_teknis" style="display: none;">
													...
													<div class="form-group" id="nama_idp_toggle" style="display: none;">
