		...
		<div class="portlet box blue-hoki">
			...
			<a href="#myModal_autocomplete" role="button" class="btn red" data-toggle="modal">Tambah Data </a>
										...
										<?php
											...
											?>
													<tr>
														...
														<td align="center">
															<a href="javascript:void(0);" onClick="javascript:popWin('<?php echo base_url('file/imb/pengajuan_imb/'.$key->id_permohonan.'/data_tanah/'.$key->dir_file);?>')" class="btn default btn-xs blue-stripe" >Lihat</a></td>
														...
														<td align="center">
														<a href="<?php echo site_url('pengajuan/removeDataTanahSumary/'.$key->id_permohonan_detail_tanah.'/'.$key->id_permohonan);?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ini?')" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></a>
														</td>
														<?}else{?>
   ...
   <div id="myModal_autocomplete" class="modal fade" role="dialog" aria-hidden="true" data-width="60%" data-backdrop="static" data-keyboard="false">
			...
			<div class="modal-content">
				...
				<div class="modal-body form">
					<form action="<?php echo site_url('pengajuan/saveDataTanahSumary'); ?>" class="form-horizontal" role="form" method="post" id="FormTambahTanah" enctype="multipart/form-data">
