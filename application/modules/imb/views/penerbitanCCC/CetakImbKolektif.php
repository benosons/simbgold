...
$pdf->Cell(2,5,':',0,0);
$pdf->Cell(10,5,"Tipe"." ".$TipeA. "||" ."Tipe"." ".$TipeB. "||"."Tipe"." ".$TipeC,0,1);


//Penulisan Jumlah Unit
/*if($unitA ='0'){
	$unitA = $unitA "Unit"; 
}*/

$pdf->Cell(33,5,'',0,0);
$pdf->Cell(42,5,'Jumlah Unit',0,0,'L');
$pdf->Cell(2,5,':',0,0);
$pdf->Cell(10,5,$unitA." ". "Unit". "||" .$unitB." ". "Unit". "||" . $unitC." ". "Unit",0,1);


//Menghitung Luas Total Bangunan
$TotalLuas  = ($TipeA * $unitA )+ ($TipeB * $unitB )+ ($TipeC * $unitC );

if($result_list['tinggi_prasarana'] == 0 || $result_list['tinggi_prasarana'] == null){
$pdf->Cell(33,5,'',0,0);
$pdf->Cell(42,5,'Total Luas Bangunan',0,0,'L');
$pdf->Cell(2,5,':',0,0);
$pdf->Cell(14,5,number_format($TotalLuas,0,'','.'),0,0);
