	...
	<div class="col-md-12">
			...
			<div class="row static-info">
				...
				<div class="col-md-8 value">
					<?=(isset($jalan_lokasi)? $jalan_lokasi : '') ;?>, Des/Kel. <?=(isset($kel)? $kel : '') ;?> Kec. <?=(isset($kec) ? $kec : '');?>,<br> <?=(isset($nama_kabkota_bg) ? $nama_kabkota_bg : '');?>, <?=(isset($nama_provinsi_bg) ? $nama_provinsi_bg : '') ;?>
				</div>
			</div>
