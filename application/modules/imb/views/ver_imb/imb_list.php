	...
	<div class="portlet-title">
		...
		<div class="portlet-body">
			<div class="form-actions">
				<?php echo form_open('imb/verifikasi',array('name'=>'frmListVerifikasi', 'id'=>'frmListVerifikasi')); ?>
				<div class="row">
						<div class="col-md-12">
			...
			?>
				...
				?>
	                <tr class="<?=$clss?>">
					  ...
					  <?}else{?>
								<?php  if ($imb->status_progress == 2) { ?>
								<td align="center"><a href="#" onClick="href='<?php echo site_url('detail/detail_imb/'.$imb->id_permohonan);?>'" class="btn btn-info btn-sm" title="Menunggu Perbaikan" id="tombolinver" data-toggle="modal" data-target="#modal-edit"><span class="glyphicon glyphicon-user"></span></a></td>
								<?}else{?>
								<td align="center"><a href="#" onClick="href='<?php echo site_url('imb/form_verifikasi/'.$imb->id_permohonan);?>'" class="btn btn-success btn-sm" title="Verifikasi Data" id="tombolver" data-toggle="modal" data-target="#modal-edit"><span class="glyphicon glyphicon-edit"></span></a></td>
								<?}?>
					  <?}?>
