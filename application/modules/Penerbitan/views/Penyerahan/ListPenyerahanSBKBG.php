	                ...
	                <tr class="<?=$clss?>">
						...
						<td align="center">
							<?php if($Draft->status == 15){ ?>
								<a href="#" onClick="Xbit(<?php echo $Draft->id?>)" class="btn btn-danger btn-sm" ><span class="glyphicon glyphicon-edit">.</span>Penyerahan PBG-SLF-SBKBG</a>
							<?php } else { ?>
		...
		<form action="<?php echo site_url('Penerbitan/PenyerahanForm/'.$Draft->id); ?>" class="form-horizontal" role="form" method="post" id="hsnya" enctype="multipart/form-data">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" align="center"><b>Penyerahan Dokumen SLF-SBKBG</b></h4>
				</div>
