...
<div id="Penyerahan" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog">
	<div class="modal-dialog ">
		<form action="<?php echo site_url('Penerbitan/PenyerahanDokEks/'.$Draft->id); ?>" class="form-horizontal" role="form" method="post" id="hsnya" enctype="multipart/form-data">
...
function GetCetakDok(id)
{
 ...
 function Xbit(id){
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('Penerbitan/PenyerahanDokumen/')?>",
                dataType : "JSON",
                data : {id:id},
