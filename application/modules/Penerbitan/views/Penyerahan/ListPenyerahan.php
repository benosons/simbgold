...
<div id="Penyerahan" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog">
	<div class="modal-dialog ">
		<form action="<?php echo site_url('Penerbitan/PenyerahanForm/'.$Draft->id); ?>" class="form-horizontal" role="form" method="post" id="hsnya" enctype="multipart/form-data">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" align="center"><b>Penyerahan Draf PBG</b></h4>
				</div>
...
<script>	
 ...
 function Xbit(id){
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('Penerbitan/Penyerahan/')?>",
                dataType : "JSON",
                data : {id:id},
