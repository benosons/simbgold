...
function fixDiv() {
	...
	if ($(window).scrollTop() > 200){
	 ...
	 $("a[title='JavaScript charts']").css("top","");
	 $("a[title='JavaScript charts']").css("bottom","0px;");
}
...
function cari_ajax_combo(tipe, parent, data, target_combo, url, proses_result, sts_loading){
	url = base_url + url;
...
function cari_ajax(parent, spinner, target, url){
