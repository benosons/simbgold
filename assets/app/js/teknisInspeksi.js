...
$.ajax({
    method: 'POST',
    url: `${base_url}Teknis/cek_step_inspeksi`,
    data: {
        id: segment
    },
    ...
    $("#form_wizard_1").bootstrapWizard({
        ...
        onNext: function (e, a, n) {
            ...
            $.ajax({
                ...
                url: `${base_url}Teknis/save_step_inspeksi`,
                success: function (response) { }
            });
            return res;
        },
...
$(document).on('submit', 'form.step-wizard', function (e) {
    ...
    $.ajax({
        type: 'POST',
        url: `${base_url}Teknis/simpan_inspeksi`,
...
$(document).on('submit', 'form.final-wizard', function (e) {
    ...
    $.ajax({
        type: 'POST',
        url: `${base_url}Teknis/simpan_data_inspeksi`,
        data: new FormData(this),
        processData: false,
        contentType: false,
        enctype: 'multipart/form-data',
